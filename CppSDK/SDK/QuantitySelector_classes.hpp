...
static_assert(sizeof(UQuantitySelector_C) == 0x000A50, "Wrong size on UQuantitySelector_C");
...
static_assert(offsetof(UQuantitySelector_C, SliderStyle_XboxOne) == 0x000668, "Member 'UQuantitySelector_C::SliderStyle_XboxOne' has a wrong offset!");
static_assert(offsetof(UQuantitySelector_C, SliderStyle_PS4) == 0x000858, "Member 'UQuantitySelector_C::SliderStyle_PS4' has a wrong offset!");
static_assert(offsetof(UQuantitySelector_C, bShowConfirmButton) == 0x000A48, "Member 'UQuantitySelector_C::bShowConfirmButton' has a wrong offset!");
static_assert(offsetof(UQuantitySelector_C, bShowCancelButton) == 0x000A49, "Member 'UQuantitySelector_C::bShowCancelButton' has a wrong offset!");
static_assert(offsetof(UQuantitySelector_C, bAllowZeroQuantity) == 0x000A4A, "Member 'UQuantitySelector_C::bAllowZeroQuantity' has a wrong offset!");
