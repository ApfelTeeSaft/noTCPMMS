...
static_assert(sizeof(UItemInspectUpgradeCallout_C) == 0x0002A8, "Wrong size on UItemInspectUpgradeCallout_C");
static_assert(offsetof(UItemInspectUpgradeCallout_C, UberGraphFrame) == 0x000218, "Member 'UItemInspectUpgradeCallout_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UItemInspectUpgradeCallout_C, EvolveButton) == 0x000220, "Member 'UItemInspectUpgradeCallout_C::EvolveButton' has a wrong offset!");
static_assert(offsetof(UItemInspectUpgradeCallout_C, Image_3) == 0x000228, "Member 'UItemInspectUpgradeCallout_C::Image_3' has a wrong offset!");
static_assert(offsetof(UItemInspectUpgradeCallout_C, ItemCount) == 0x000230, "Member 'UItemInspectUpgradeCallout_C::ItemCount' has a wrong offset!");
static_assert(offsetof(UItemInspectUpgradeCallout_C, ItemCountBG) == 0x000238, "Member 'UItemInspectUpgradeCallout_C::ItemCountBG' has a wrong offset!");
static_assert(offsetof(UItemInspectUpgradeCallout_C, MainBorderWidget) == 0x000240, "Member 'UItemInspectUpgradeCallout_C::MainBorderWidget' has a wrong offset!");
static_assert(offsetof(UItemInspectUpgradeCallout_C, SwitcherButton) == 0x000248, "Member 'UItemInspectUpgradeCallout_C::SwitcherButton' has a wrong offset!");
static_assert(offsetof(UItemInspectUpgradeCallout_C, UpgradeButton) == 0x000250, "Member 'UItemInspectUpgradeCallout_C::UpgradeButton' has a wrong offset!");
static_assert(offsetof(UItemInspectUpgradeCallout_C, UpgradeHighlight) == 0x000258, "Member 'UItemInspectUpgradeCallout_C::UpgradeHighlight' has a wrong offset!");
static_assert(offsetof(UItemInspectUpgradeCallout_C, UpgradeText) == 0x000260, "Member 'UItemInspectUpgradeCallout_C::UpgradeText' has a wrong offset!");
static_assert(offsetof(UItemInspectUpgradeCallout_C, UpgradeTextOverlay) == 0x000268, "Member 'UItemInspectUpgradeCallout_C::UpgradeTextOverlay' has a wrong offset!");
static_assert(offsetof(UItemInspectUpgradeCallout_C, Item) == 0x000270, "Member 'UItemInspectUpgradeCallout_C::Item' has a wrong offset!");
static_assert(offsetof(UItemInspectUpgradeCallout_C, UpgradeCost) == 0x000278, "Member 'UItemInspectUpgradeCallout_C::UpgradeCost' has a wrong offset!");
static_assert(offsetof(UItemInspectUpgradeCallout_C, OnRequestUpgrade) == 0x000280, "Member 'UItemInspectUpgradeCallout_C::OnRequestUpgrade' has a wrong offset!");
static_assert(offsetof(UItemInspectUpgradeCallout_C, UpgradeColor) == 0x000290, "Member 'UItemInspectUpgradeCallout_C::UpgradeColor' has a wrong offset!");
static_assert(offsetof(UItemInspectUpgradeCallout_C, IsMaxLevel) == 0x0002A0, "Member 'UItemInspectUpgradeCallout_C::IsMaxLevel' has a wrong offset!");
