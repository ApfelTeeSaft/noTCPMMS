...
{
public:
	struct FSlateBrush                            InIcon;                                            // 0x0000(0x0078)(BlueprintVisible, BlueprintReadOnly, Parm)
	class UHorizontalBoxSlot*                     K2Node_DynamicCast_AsHorizontal_Box_Slot;          // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0080(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(CollectionBar_C_SetIcon) == 0x000008, "Wrong alignment on CollectionBar_C_SetIcon");
static_assert(sizeof(CollectionBar_C_SetIcon) == 0x000088, "Wrong size on CollectionBar_C_SetIcon");
static_assert(offsetof(CollectionBar_C_SetIcon, InIcon) == 0x000000, "Member 'CollectionBar_C_SetIcon::InIcon' has a wrong offset!");
static_assert(offsetof(CollectionBar_C_SetIcon, K2Node_DynamicCast_AsHorizontal_Box_Slot) == 0x000078, "Member 'CollectionBar_C_SetIcon::K2Node_DynamicCast_AsHorizontal_Box_Slot' has a wrong offset!");
static_assert(offsetof(CollectionBar_C_SetIcon, K2Node_DynamicCast_bSuccess) == 0x000080, "Member 'CollectionBar_C_SetIcon::K2Node_DynamicCast_bSuccess' has a wrong offset!");
