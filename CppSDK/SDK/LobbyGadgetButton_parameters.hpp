...
static_assert(offsetof(LobbyGadgetButton_C_Focus, CallFunc_GetUINavigationManager_ReturnValue) == 0x000000, "Member 'LobbyGadgetButton_C_Focus::CallFunc_GetUINavigationManager_ReturnValue' has a wrong offset!");
...
{
public:
	class UCommonButton*                          Button_0;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
{
public:
	class ULobbyGadgetButton_C*                   GadgetButton;                                      // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
