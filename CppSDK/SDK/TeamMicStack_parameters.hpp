...
public:
	...
	struct FFortTeamMemberInfo                    CallFunc_Array_Get_Item;                           // 0x0070(0x01A8)()
...
static_assert(sizeof(TeamMicStack_C_ExecuteUbergraph_TeamMicStack) == 0x000230, "Wrong size on TeamMicStack_C_ExecuteUbergraph_TeamMicStack");
...
static_assert(offsetof(TeamMicStack_C_ExecuteUbergraph_TeamMicStack, CallFunc_Array_Length_ReturnValue) == 0x000218, "Member 'TeamMicStack_C_ExecuteUbergraph_TeamMicStack::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_ExecuteUbergraph_TeamMicStack, CallFunc_Less_IntInt_ReturnValue) == 0x00021C, "Member 'TeamMicStack_C_ExecuteUbergraph_TeamMicStack::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_ExecuteUbergraph_TeamMicStack, K2Node_CreateDelegate_OutputDelegate4) == 0x000220, "Member 'TeamMicStack_C_ExecuteUbergraph_TeamMicStack::K2Node_CreateDelegate_OutputDelegate4' has a wrong offset!");
...
public:
	...
	class UCinematicMinusTeamMics_C*              CallFunc_Array_Get_Item;                           // 0x01C0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(TeamMicStack_C_HandleTeamMemberChanged) == 0x0001D0, "Wrong size on TeamMicStack_C_HandleTeamMemberChanged");
...
static_assert(offsetof(TeamMicStack_C_HandleTeamMemberChanged, CallFunc_Array_Length_ReturnValue) == 0x0001A8, "Member 'TeamMicStack_C_HandleTeamMemberChanged::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_HandleTeamMemberChanged, CallFunc_GetContext_ReturnValue) == 0x0001B0, "Member 'TeamMicStack_C_HandleTeamMemberChanged::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_HandleTeamMemberChanged, CallFunc_Subtract_IntInt_ReturnValue) == 0x0001B8, "Member 'TeamMicStack_C_HandleTeamMemberChanged::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_HandleTeamMemberChanged, CallFunc_IsLocalPlayersUniqueID_ReturnValue) == 0x0001BC, "Member 'TeamMicStack_C_HandleTeamMemberChanged::CallFunc_IsLocalPlayersUniqueID_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_HandleTeamMemberChanged, CallFunc_Array_Get_Item) == 0x0001C0, "Member 'TeamMicStack_C_HandleTeamMemberChanged::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_HandleTeamMemberChanged, CallFunc_Less_IntInt_ReturnValue) == 0x0001C8, "Member 'TeamMicStack_C_HandleTeamMemberChanged::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
...
public:
	...
	TArray<class UHUDMinusTeamMemberInfo_C*>      K2Node_MakeArray_Array;                            // 0x01B8(0x0010)(ZeroConstructor, ReferenceParm)
	bool                                          CallFunc_Greater_IntInt_ReturnValue;               // 0x01C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1C9[0x7];                                      // 0x01C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UHUDMinusTeamMemberInfo_C*              CallFunc_Array_Get_Item;                           // 0x01D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UCinematicMinusTeamMics_C*              CallFunc_Create_ReturnValue;                       // 0x01E8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FMargin                                K2Node_MakeStruct_Margin;                          // 0x01F0(0x0010)(NoDestructor)
...
static_assert(sizeof(TeamMicStack_C_ShiftTeamMembers) == 0x000218, "Wrong size on TeamMicStack_C_ShiftTeamMembers");
...
static_assert(offsetof(TeamMicStack_C_ShiftTeamMembers, Index_0) == 0x0001A8, "Member 'TeamMicStack_C_ShiftTeamMembers::Index_0' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_ShiftTeamMembers, CurrentIndex) == 0x0001AC, "Member 'TeamMicStack_C_ShiftTeamMembers::CurrentIndex' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_ShiftTeamMembers, Temp_int_Array_Index_Variable) == 0x0001B0, "Member 'TeamMicStack_C_ShiftTeamMembers::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_ShiftTeamMembers, K2Node_MakeArray_Array) == 0x0001B8, "Member 'TeamMicStack_C_ShiftTeamMembers::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_ShiftTeamMembers, CallFunc_Greater_IntInt_ReturnValue) == 0x0001C8, "Member 'TeamMicStack_C_ShiftTeamMembers::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_ShiftTeamMembers, CallFunc_Array_Get_Item) == 0x0001D0, "Member 'TeamMicStack_C_ShiftTeamMembers::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_ShiftTeamMembers, CallFunc_Array_Length_ReturnValue) == 0x0001D8, "Member 'TeamMicStack_C_ShiftTeamMembers::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_ShiftTeamMembers, CallFunc_GetOwningPlayer_ReturnValue) == 0x0001E0, "Member 'TeamMicStack_C_ShiftTeamMembers::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_ShiftTeamMembers, CallFunc_Create_ReturnValue) == 0x0001E8, "Member 'TeamMicStack_C_ShiftTeamMembers::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_ShiftTeamMembers, K2Node_MakeStruct_Margin) == 0x0001F0, "Member 'TeamMicStack_C_ShiftTeamMembers::K2Node_MakeStruct_Margin' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_ShiftTeamMembers, Temp_int_Loop_Counter_Variable) == 0x000200, "Member 'TeamMicStack_C_ShiftTeamMembers::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_ShiftTeamMembers, CallFunc_AddChildToVerticalBox_ReturnValue) == 0x000208, "Member 'TeamMicStack_C_ShiftTeamMembers::CallFunc_AddChildToVerticalBox_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_ShiftTeamMembers, CallFunc_Less_IntInt_ReturnValue) == 0x000210, "Member 'TeamMicStack_C_ShiftTeamMembers::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_ShiftTeamMembers, CallFunc_Add_IntInt_ReturnValue) == 0x000214, "Member 'TeamMicStack_C_ShiftTeamMembers::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
...
public:
	...
	class UCinematicMinusTeamMics_C*              CallFunc_Create_ReturnValue;                       // 0x01C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(TeamMicStack_C_AppendTeamMember) == 0x0001E0, "Wrong size on TeamMicStack_C_AppendTeamMember");
...
static_assert(offsetof(TeamMicStack_C_AppendTeamMember, CurrentIndex) == 0x0001A8, "Member 'TeamMicStack_C_AppendTeamMember::CurrentIndex' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_AppendTeamMember, K2Node_MakeStruct_Margin) == 0x0001AC, "Member 'TeamMicStack_C_AppendTeamMember::K2Node_MakeStruct_Margin' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_AppendTeamMember, CallFunc_GetOwningPlayer_ReturnValue) == 0x0001C0, "Member 'TeamMicStack_C_AppendTeamMember::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_AppendTeamMember, CallFunc_Create_ReturnValue) == 0x0001C8, "Member 'TeamMicStack_C_AppendTeamMember::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_AppendTeamMember, CallFunc_AddChildToVerticalBox_ReturnValue) == 0x0001D0, "Member 'TeamMicStack_C_AppendTeamMember::CallFunc_AddChildToVerticalBox_ReturnValue' has a wrong offset!");
static_assert(offsetof(TeamMicStack_C_AppendTeamMember, CallFunc_Array_Add_ReturnValue) == 0x0001D8, "Member 'TeamMicStack_C_AppendTeamMember::CallFunc_Array_Add_ReturnValue' has a wrong offset!");
