...
// Parameters:
// class UFortDirectAcquisitionOfferInfo*  OfferData_0                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UAthenaDirectAcquisitionScreen_C::GenerateOfferWidget(class UFortDirectAcquisitionOfferInfo* OfferData_0)
{
	static class UFunction* Func = nullptr;
