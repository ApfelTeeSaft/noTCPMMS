...
public:
	...
	class UFortPickerContext*                     CallFunc_GetContext_ReturnValue2;                  // 0x0010(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFortHUDContext*                        CallFunc_GetContext_ReturnValue4;                  // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCommonUIContext*                       CallFunc_GetContext_ReturnValue5;                  // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(bool bCursorModeEnabled, class FName ActionName, class UUserWidget* CursorModeContentWidget)> K2Node_CreateDelegate_OutputDelegate5;             // 0x0088(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(bool bIsTargeting)>            K2Node_CreateDelegate_OutputDelegate6;             // 0x0098(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(struct FEndOfDayRecap& EndOfDayRecap)> K2Node_CreateDelegate_OutputDelegate7;             // 0x00A8(0x0010)(ZeroConstructor, NoDestructor)
	class UFortHUDContext*                        CallFunc_GetContext_ReturnValue6;                  // 0x00B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UBuildingInfoIndicator_C*               CallFunc_Create_ReturnValue;                       // 0x00C8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortActorCanvasSlot*                   CallFunc_AddActorIndicator_ReturnValue;            // 0x00D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortHUDContext*                        CallFunc_GetContext_ReturnValue7;                  // 0x00D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(bool bIndicatorsEnabled)>      K2Node_CreateDelegate_OutputDelegate8;             // 0x00E0(0x0010)(ZeroConstructor, NoDestructor)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x00F0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_F1[0x7];                                       // 0x00F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortHUDContext*                        CallFunc_GetContext_ReturnValue8;                  // 0x00F8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_IsValid_ReturnValue2;                     // 0x011C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UFortGlobalUIContext*                   CallFunc_GetContext_ReturnValue9;                  // 0x0120(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class APlayerController*                      CallFunc_GetOwningPlayer_ReturnValue2;             // 0x0128(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UInteractionIndicator_C*                CallFunc_Create_ReturnValue2;                      // 0x0138(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(bool IsVisible)>               K2Node_CreateDelegate_OutputDelegate9;             // 0x0150(0x0010)(ZeroConstructor, NoDestructor)
	...
	class UFortInventoryContext*                  CallFunc_GetContext_ReturnValue10;                 // 0x0170(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FEndOfDayRecap                         K2Node_CustomEvent_EndOfDayRecap;                  // 0x0178(0x0020)(ConstParm)
	TDelegate<void(EFortCompletionResult Result)> K2Node_CreateDelegate_OutputDelegate10;            // 0x0198(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(EFortPickerMode Mode, int32 InitialOption, bool bIgnoreFirstAccept)> K2Node_CreateDelegate_OutputDelegate11;            // 0x01A8(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate12;            // 0x01B8(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(class AActor* PointOfInterest, class FText DisplayText, class UTexture2D* DisplayImage)> K2Node_CreateDelegate_OutputDelegate13;            // 0x01C8(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(class AActor* PointOfInterest)> K2Node_CreateDelegate_OutputDelegate14;            // 0x01D8(0x0010)(ZeroConstructor, NoDestructor)
	class UFortGlobalUIContext*                   CallFunc_GetContext_ReturnValue11;                 // 0x01E8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UWidget*                                K2Node_Event_Widget;                               // 0x01F0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void()>                             K2Node_CreateDelegate_OutputDelegate15;            // 0x0200(0x0010)(ZeroConstructor, NoDestructor)
	...
	class UFortGlobalUIContext*                   CallFunc_GetContext_ReturnValue12;                 // 0x0488(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue3;                     // 0x0490(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_491[0x7];                                      // 0x0491(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TDelegate<void(TArray<class UFortQuestItem*>& Quests)> K2Node_CreateDelegate_OutputDelegate16;            // 0x0498(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(struct FGameplayTagContainer& HiddenHUDElementTags)> K2Node_CreateDelegate_OutputDelegate17;            // 0x04A8(0x0010)(ZeroConstructor, NoDestructor)
};
static_assert(alignof(HUD_C_ExecuteUbergraph_HUD) == 0x000010, "Wrong alignment on HUD_C_ExecuteUbergraph_HUD");
static_assert(sizeof(HUD_C_ExecuteUbergraph_HUD) == 0x0004C0, "Wrong size on HUD_C_ExecuteUbergraph_HUD");
...
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetContext_ReturnValue2) == 0x000010, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetContext_ReturnValue3) == 0x000018, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetContext_ReturnValue3' has a wrong offset!");
...
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetContext_ReturnValue4) == 0x000028, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetContext_ReturnValue4' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetContext_ReturnValue5) == 0x000030, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetContext_ReturnValue5' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetInputManager_ReturnValue) == 0x000038, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetInputManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_Event_PreviousUIState) == 0x000040, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_Event_PreviousUIState' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_CreateDelegate_OutputDelegate) == 0x000048, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_CreateDelegate_OutputDelegate7) == 0x0000A8, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_CreateDelegate_OutputDelegate7' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetContext_ReturnValue6) == 0x0000B8, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetContext_ReturnValue6' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetOwningPlayer_ReturnValue) == 0x0000C0, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_Create_ReturnValue) == 0x0000C8, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_AddActorIndicator_ReturnValue) == 0x0000D0, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_AddActorIndicator_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetContext_ReturnValue7) == 0x0000D8, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetContext_ReturnValue7' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_CreateDelegate_OutputDelegate8) == 0x0000E0, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_CreateDelegate_OutputDelegate8' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_IsValid_ReturnValue) == 0x0000F0, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetContext_ReturnValue8) == 0x0000F8, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetContext_ReturnValue8' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_CustomEvent_Quests) == 0x000100, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_CustomEvent_Quests' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetGameStateZone_ReturnValue) == 0x000110, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetGameStateZone_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_Array_Length_ReturnValue) == 0x000118, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_IsValid_ReturnValue2) == 0x00011C, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_IsValid_ReturnValue2' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetGameplayState_ReturnValue) == 0x00011D, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetGameplayState_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x00011E, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetContext_ReturnValue9) == 0x000120, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetContext_ReturnValue9' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetOwningPlayer_ReturnValue2) == 0x000128, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetOwningPlayer_ReturnValue2' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetQuestManager_ReturnValue) == 0x000130, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetQuestManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_Create_ReturnValue2) == 0x000138, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_Create_ReturnValue2' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_AddActorIndicator_ReturnValue2) == 0x000140, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_AddActorIndicator_ReturnValue2' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_CustomEvent_bVisible) == 0x000148, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_CustomEvent_bVisible' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_CreateDelegate_OutputDelegate9) == 0x000150, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_CreateDelegate_OutputDelegate9' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, Temp_int_Loop_Counter_Variable) == 0x000160, "Member 'HUD_C_ExecuteUbergraph_HUD::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_Less_IntInt_ReturnValue) == 0x000164, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_Add_IntInt_ReturnValue) == 0x000168, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetContext_ReturnValue10) == 0x000170, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetContext_ReturnValue10' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_CustomEvent_EndOfDayRecap) == 0x000178, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_CustomEvent_EndOfDayRecap' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_CreateDelegate_OutputDelegate10) == 0x000198, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_CreateDelegate_OutputDelegate10' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_CreateDelegate_OutputDelegate11) == 0x0001A8, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_CreateDelegate_OutputDelegate11' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_CreateDelegate_OutputDelegate12) == 0x0001B8, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_CreateDelegate_OutputDelegate12' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_CreateDelegate_OutputDelegate13) == 0x0001C8, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_CreateDelegate_OutputDelegate13' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_CreateDelegate_OutputDelegate14) == 0x0001D8, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_CreateDelegate_OutputDelegate14' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetContext_ReturnValue11) == 0x0001E8, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetContext_ReturnValue11' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_Event_Widget) == 0x0001F0, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_Event_Widget' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_Event_State) == 0x0001F8, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_Event_State' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_CreateDelegate_OutputDelegate15) == 0x000200, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_CreateDelegate_OutputDelegate15' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, Temp_int_Array_Index_Variable) == 0x000210, "Member 'HUD_C_ExecuteUbergraph_HUD::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_Array_Get_Item) == 0x000218, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetItemSmallPreviewImageBrush_ReturnValue) == 0x000220, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetItemSmallPreviewImageBrush_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetDisplayName_ReturnValue) == 0x000298, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetDisplayName_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_MakeStruct_FormatArgumentData) == 0x0002B0, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_CustomEvent_UsingGamepad) == 0x0002F0, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_CustomEvent_UsingGamepad' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_MakeArray_Array) == 0x0002F8, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_Format_ReturnValue) == 0x000308, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_Select_Default) == 0x000320, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_MakeStruct_FortDialogDescription) == 0x000330, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_MakeStruct_FortDialogDescription' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_TriggerNotification_ReturnValue) == 0x000480, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_TriggerNotification_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_GetContext_ReturnValue12) == 0x000488, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_GetContext_ReturnValue12' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, CallFunc_IsValid_ReturnValue3) == 0x000490, "Member 'HUD_C_ExecuteUbergraph_HUD::CallFunc_IsValid_ReturnValue3' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_CreateDelegate_OutputDelegate16) == 0x000498, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_CreateDelegate_OutputDelegate16' has a wrong offset!");
static_assert(offsetof(HUD_C_ExecuteUbergraph_HUD, K2Node_CreateDelegate_OutputDelegate17) == 0x0004A8, "Member 'HUD_C_ExecuteUbergraph_HUD::K2Node_CreateDelegate_OutputDelegate17' has a wrong offset!");
...
public:
	...
	EFortInputMode                                Temp_byte_Variable2;                               // 0x001B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	ESlateVisibility                              Temp_byte_Variable3;                               // 0x0030(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	ESlateVisibility                              Temp_byte_Variable4;                               // 0x0040(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_41[0x7];                                       // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UUIManager_C*                           K2Node_DynamicCast_AsUIManager;                    // 0x0048(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0050(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_51[0x7];                                       // 0x0051(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UFeedback_C*                            K2Node_DynamicCast_AsFeedback;                     // 0x0058(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess2;                      // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_61[0x7];                                       // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UFortUIManagerWidget_NUI*               CallFunc_GetUIManagerWidget_ReturnValue2;          // 0x0068(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UMgmtTabsScreen_C*                      K2Node_DynamicCast_AsMgmt_Tabs_Screen;             // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UCommonUIContext*                       CallFunc_GetContext_ReturnValue3;                  // 0x00B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCommonInputManager*                    CallFunc_GetInputManager_ReturnValue2;             // 0x00B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(HUD_C_HandleCursorModeChanged) == 0x000008, "Wrong alignment on HUD_C_HandleCursorModeChanged");
static_assert(sizeof(HUD_C_HandleCursorModeChanged) == 0x0000C0, "Wrong size on HUD_C_HandleCursorModeChanged");
...
static_assert(offsetof(HUD_C_HandleCursorModeChanged, CallFunc_NotEqual_NameName_ReturnValue) == 0x000019, "Member 'HUD_C_HandleCursorModeChanged::CallFunc_NotEqual_NameName_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, Temp_byte_Variable) == 0x00001A, "Member 'HUD_C_HandleCursorModeChanged::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, Temp_byte_Variable2) == 0x00001B, "Member 'HUD_C_HandleCursorModeChanged::Temp_byte_Variable2' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, CallFunc_Conv_ByteToInt_ReturnValue) == 0x00001C, "Member 'HUD_C_HandleCursorModeChanged::CallFunc_Conv_ByteToInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, Temp_bool_Variable) == 0x000020, "Member 'HUD_C_HandleCursorModeChanged::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, CallFunc_GetContext_ReturnValue) == 0x000028, "Member 'HUD_C_HandleCursorModeChanged::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, Temp_byte_Variable3) == 0x000030, "Member 'HUD_C_HandleCursorModeChanged::Temp_byte_Variable3' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, K2Node_Select_Default) == 0x000031, "Member 'HUD_C_HandleCursorModeChanged::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, CallFunc_GetUIManagerWidget_ReturnValue) == 0x000038, "Member 'HUD_C_HandleCursorModeChanged::CallFunc_GetUIManagerWidget_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, Temp_byte_Variable4) == 0x000040, "Member 'HUD_C_HandleCursorModeChanged::Temp_byte_Variable4' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, K2Node_DynamicCast_AsUIManager) == 0x000048, "Member 'HUD_C_HandleCursorModeChanged::K2Node_DynamicCast_AsUIManager' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, K2Node_DynamicCast_bSuccess) == 0x000050, "Member 'HUD_C_HandleCursorModeChanged::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, K2Node_DynamicCast_AsFeedback) == 0x000058, "Member 'HUD_C_HandleCursorModeChanged::K2Node_DynamicCast_AsFeedback' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, K2Node_DynamicCast_bSuccess2) == 0x000060, "Member 'HUD_C_HandleCursorModeChanged::K2Node_DynamicCast_bSuccess2' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, CallFunc_GetUIManagerWidget_ReturnValue2) == 0x000068, "Member 'HUD_C_HandleCursorModeChanged::CallFunc_GetUIManagerWidget_ReturnValue2' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, CallFunc_GetCachedWidget_ReturnValue) == 0x000070, "Member 'HUD_C_HandleCursorModeChanged::CallFunc_GetCachedWidget_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, K2Node_DynamicCast_AsMgmt_Tabs_Screen) == 0x000078, "Member 'HUD_C_HandleCursorModeChanged::K2Node_DynamicCast_AsMgmt_Tabs_Screen' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, K2Node_DynamicCast_bSuccess3) == 0x000080, "Member 'HUD_C_HandleCursorModeChanged::K2Node_DynamicCast_bSuccess3' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, CallFunc_GetActiveTab_ReturnValue) == 0x000088, "Member 'HUD_C_HandleCursorModeChanged::CallFunc_GetActiveTab_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, Temp_bool_Variable2) == 0x000090, "Member 'HUD_C_HandleCursorModeChanged::Temp_bool_Variable2' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, CallFunc_GetContext_ReturnValue2) == 0x000098, "Member 'HUD_C_HandleCursorModeChanged::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, CallFunc_GetInputManager_ReturnValue) == 0x0000A0, "Member 'HUD_C_HandleCursorModeChanged::CallFunc_GetInputManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, K2Node_Select2_Default) == 0x0000A8, "Member 'HUD_C_HandleCursorModeChanged::K2Node_Select2_Default' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, CallFunc_GetContext_ReturnValue3) == 0x0000B0, "Member 'HUD_C_HandleCursorModeChanged::CallFunc_GetContext_ReturnValue3' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleCursorModeChanged, CallFunc_GetInputManager_ReturnValue2) == 0x0000B8, "Member 'HUD_C_HandleCursorModeChanged::CallFunc_GetInputManager_ReturnValue2' has a wrong offset!");
...
public:
	...
	class UUserWidget*                            CursorWidget;                                      // 0x0010(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(HUD_C_HandleOnPointOfInterestRemoved, CallFunc_RemovePointOfInterest_Removed) == 0x000029, "Member 'HUD_C_HandleOnPointOfInterestRemoved::CallFunc_RemovePointOfInterest_Removed' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleOnPointOfInterestRemoved, CallFunc_Array_Get_Item) == 0x000030, "Member 'HUD_C_HandleOnPointOfInterestRemoved::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleOnPointOfInterestRemoved, CallFunc_Array_Length_ReturnValue) == 0x000038, "Member 'HUD_C_HandleOnPointOfInterestRemoved::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleOnPointOfInterestRemoved, CallFunc_Less_IntInt_ReturnValue) == 0x00003C, "Member 'HUD_C_HandleOnPointOfInterestRemoved::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_HandleOnPointOfInterestRemoved, CallFunc_BooleanAND_ReturnValue) == 0x00003D, "Member 'HUD_C_HandleOnPointOfInterestRemoved::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
...
static_assert(alignof(HUD_C_OpenSocialMenu) == 0x000008, "Wrong alignment on HUD_C_OpenSocialMenu");
static_assert(sizeof(HUD_C_OpenSocialMenu) == 0x000008, "Wrong size on HUD_C_OpenSocialMenu");
static_assert(offsetof(HUD_C_OpenSocialMenu, CallFunc_GetContext_ReturnValue) == 0x000000, "Member 'HUD_C_OpenSocialMenu::CallFunc_GetContext_ReturnValue' has a wrong offset!");
...
public:
	...
	class UMgmtTabsScreen_C*                      K2Node_DynamicCast_AsMgmt_Tabs_Screen;             // 0x0030(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0038(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(HUD_C_PrepareMgmtMenu) == 0x000008, "Wrong alignment on HUD_C_PrepareMgmtMenu");
static_assert(sizeof(HUD_C_PrepareMgmtMenu) == 0x000040, "Wrong size on HUD_C_PrepareMgmtMenu");
static_assert(offsetof(HUD_C_PrepareMgmtMenu, CallFunc_GetContext_ReturnValue) == 0x000000, "Member 'HUD_C_PrepareMgmtMenu::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_PrepareMgmtMenu, K2Node_CreateDelegate_OutputDelegate) == 0x000008, "Member 'HUD_C_PrepareMgmtMenu::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(HUD_C_PrepareMgmtMenu, CallFunc_GetContext_ReturnValue2) == 0x000018, "Member 'HUD_C_PrepareMgmtMenu::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
static_assert(offsetof(HUD_C_PrepareMgmtMenu, CallFunc_GetUIManagerWidget_ReturnValue) == 0x000020, "Member 'HUD_C_PrepareMgmtMenu::CallFunc_GetUIManagerWidget_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_PrepareMgmtMenu, CallFunc_GetCachedWidget_ReturnValue) == 0x000028, "Member 'HUD_C_PrepareMgmtMenu::CallFunc_GetCachedWidget_ReturnValue' has a wrong offset!");
static_assert(offsetof(HUD_C_PrepareMgmtMenu, K2Node_DynamicCast_AsMgmt_Tabs_Screen) == 0x000030, "Member 'HUD_C_PrepareMgmtMenu::K2Node_DynamicCast_AsMgmt_Tabs_Screen' has a wrong offset!");
static_assert(offsetof(HUD_C_PrepareMgmtMenu, K2Node_DynamicCast_bSuccess) == 0x000038, "Member 'HUD_C_PrepareMgmtMenu::K2Node_DynamicCast_bSuccess' has a wrong offset!");
