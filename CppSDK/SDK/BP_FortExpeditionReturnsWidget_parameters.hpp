...
public:
	...
	bool                                          CallFunc_IsExpeditionCompleted_ReturnValue;        // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_11[0x7];                                       // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	struct FDateTime                              CallFunc_Get_Mcp_Relative_Utc_Now_UtcNow;          // 0x0018(0x0008)(NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(BP_FortExpeditionReturnsWidget_C_Set_Expedition_Return_Time, CallFunc_IsExpeditionCompleted_ReturnValue) == 0x000010, "Member 'BP_FortExpeditionReturnsWidget_C_Set_Expedition_Return_Time::CallFunc_IsExpeditionCompleted_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_FortExpeditionReturnsWidget_C_Set_Expedition_Return_Time, CallFunc_Get_Mcp_Relative_Utc_Now_UtcNow) == 0x000018, "Member 'BP_FortExpeditionReturnsWidget_C_Set_Expedition_Return_Time::CallFunc_Get_Mcp_Relative_Utc_Now_UtcNow' has a wrong offset!");
