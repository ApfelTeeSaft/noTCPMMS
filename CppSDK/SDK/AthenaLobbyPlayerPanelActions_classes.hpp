...
public:
	...
	class UIconTextButton_C*                      ViewProfileButton;                                 // 0x0238(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UIconTextButton_C*                      HoveredActionButton;                               // 0x0240(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	UMulticastDelegateProperty_                   OnGadgetsClicked;                                  // 0x0248(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	struct FFortTeamMemberInfo                    TeamMemberInfo;                                    // 0x0258(0x01A8)(Edit, BlueprintVisible, ExposeOnSpawn)
...
static_assert(sizeof(UAthenaLobbyPlayerPanelActions_C) == 0x000400, "Wrong size on UAthenaLobbyPlayerPanelActions_C");
...
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, ViewProfileButton) == 0x000238, "Member 'UAthenaLobbyPlayerPanelActions_C::ViewProfileButton' has a wrong offset!");
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, HoveredActionButton) == 0x000240, "Member 'UAthenaLobbyPlayerPanelActions_C::HoveredActionButton' has a wrong offset!");
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, OnGadgetsClicked) == 0x000248, "Member 'UAthenaLobbyPlayerPanelActions_C::OnGadgetsClicked' has a wrong offset!");
static_assert(offsetof(UAthenaLobbyPlayerPanelActions_C, TeamMemberInfo) == 0x000258, "Member 'UAthenaLobbyPlayerPanelActions_C::TeamMemberInfo' has a wrong offset!");
