...
void UAthenaHUD_C::SquadMembersChanged()
{
	...
	if (Func == nullptr)
		Func = Class->GetFunction("AthenaHUD_C", "SquadMembersChanged");
...
void UAthenaHUD_C::AddSquadMemberIndicator(class AFortPlayerStateAthena* Player_State, int32 Team_Member_Index)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AthenaHUD_C", "AddSquadMemberIndicator");

	Params::AthenaHUD_C_AddSquadMemberIndicator Parms{};
