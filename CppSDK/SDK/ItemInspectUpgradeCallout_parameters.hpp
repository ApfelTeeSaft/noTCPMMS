...
public:
	...
	struct FFortItemQuantityPair                  CallFunc_Array_Get_Item2;                          // 0x0080(0x0030)()
...
static_assert(offsetof(ItemInspectUpgradeCallout_C_ShowEvolutionInfo, CallFunc_Array_Get_Item2) == 0x000080, "Member 'ItemInspectUpgradeCallout_C_ShowEvolutionInfo::CallFunc_Array_Get_Item2' has a wrong offset!");
static_assert(offsetof(ItemInspectUpgradeCallout_C_ShowEvolutionInfo, CallFunc_GetContext_ReturnValue2) == 0x0000B0, "Member 'ItemInspectUpgradeCallout_C_ShowEvolutionInfo::CallFunc_GetContext_ReturnValue2' has a wrong offset!");
