...
public:
	...
	class UWidget*                                CallFunc_GetChildAt_ReturnValue;                   // 0x0048(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPinnedSchematicItemWidget_C*           K2Node_DynamicCast_AsPinned_Schematic_Item_Widget; // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UWidget*                                CallFunc_GetChildAt_ReturnValue2;                  // 0x0080(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPinnedSchematicItemWidget_C*           K2Node_DynamicCast_AsPinned_Schematic_Item_Widget2; // 0x0088(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, CallFunc_GetPinnedSchematicList_PinnedItems) == 0x000030, "Member 'PinnedSchematicItemsWidget_C_Refresh::CallFunc_GetPinnedSchematicList_PinnedItems' has a wrong offset!");
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, CallFunc_Add_IntInt_ReturnValue) == 0x000040, "Member 'PinnedSchematicItemsWidget_C_Refresh::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, CallFunc_GetChildAt_ReturnValue) == 0x000048, "Member 'PinnedSchematicItemsWidget_C_Refresh::CallFunc_GetChildAt_ReturnValue' has a wrong offset!");
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, K2Node_DynamicCast_AsPinned_Schematic_Item_Widget) == 0x000050, "Member 'PinnedSchematicItemsWidget_C_Refresh::K2Node_DynamicCast_AsPinned_Schematic_Item_Widget' has a wrong offset!");
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, K2Node_DynamicCast_bSuccess) == 0x000058, "Member 'PinnedSchematicItemsWidget_C_Refresh::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, CallFunc_Array_Get_Item) == 0x000060, "Member 'PinnedSchematicItemsWidget_C_Refresh::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, CallFunc_Array_Length_ReturnValue) == 0x000068, "Member 'PinnedSchematicItemsWidget_C_Refresh::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, CallFunc_Less_IntInt_ReturnValue) == 0x00006C, "Member 'PinnedSchematicItemsWidget_C_Refresh::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, CallFunc_GetChildrenCount_ReturnValue) == 0x000070, "Member 'PinnedSchematicItemsWidget_C_Refresh::CallFunc_GetChildrenCount_ReturnValue' has a wrong offset!");
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, CallFunc_Subtract_IntInt_ReturnValue) == 0x000074, "Member 'PinnedSchematicItemsWidget_C_Refresh::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000078, "Member 'PinnedSchematicItemsWidget_C_Refresh::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, CallFunc_GetChildAt_ReturnValue2) == 0x000080, "Member 'PinnedSchematicItemsWidget_C_Refresh::CallFunc_GetChildAt_ReturnValue2' has a wrong offset!");
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, K2Node_DynamicCast_AsPinned_Schematic_Item_Widget2) == 0x000088, "Member 'PinnedSchematicItemsWidget_C_Refresh::K2Node_DynamicCast_AsPinned_Schematic_Item_Widget2' has a wrong offset!");
static_assert(offsetof(PinnedSchematicItemsWidget_C_Refresh, K2Node_DynamicCast_bSuccess2) == 0x000090, "Member 'PinnedSchematicItemsWidget_C_Refresh::K2Node_DynamicCast_bSuccess2' has a wrong offset!");
