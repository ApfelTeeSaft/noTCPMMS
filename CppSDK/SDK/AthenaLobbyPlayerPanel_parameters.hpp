...
static_assert(sizeof(AthenaLobbyPlayerPanel_C_SetTeamMemberInfo) == 0x0001A8, "Wrong size on AthenaLobbyPlayerPanel_C_SetTeamMemberInfo");
...
public:
	struct FFortTeamMemberInfo                    TeamMemberInfo_0;                                  // 0x0000(0x01A8)(BlueprintVisible, BlueprintReadOnly, Parm)
	bool                                          CallFunc_AreUniqueIDsIdentical_ReturnValue;        // 0x01A8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(AthenaLobbyPlayerPanel_C_OnTeamMemberStateChanged) == 0x0001B0, "Wrong size on AthenaLobbyPlayerPanel_C_OnTeamMemberStateChanged");
...
static_assert(offsetof(AthenaLobbyPlayerPanel_C_OnTeamMemberStateChanged, CallFunc_AreUniqueIDsIdentical_ReturnValue) == 0x0001A8, "Member 'AthenaLobbyPlayerPanel_C_OnTeamMemberStateChanged::CallFunc_AreUniqueIDsIdentical_ReturnValue' has a wrong offset!");
