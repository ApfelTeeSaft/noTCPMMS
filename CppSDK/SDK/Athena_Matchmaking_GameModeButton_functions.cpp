...
void UAthena_Matchmaking_GameModeButton_C::SetupGameModeButton(const class FText& ModeDisplayName, bool bHasExtraInfo, bool bIsEnabled_0, const class FText& ExtraInfoText)
{
	static class UFunction* Func = nullptr;
