...
static_assert(sizeof(UWidget) == 0x000100, "Wrong size on UWidget");
...
static_assert(offsetof(UWidget, NativeBindings) == 0x0000F0, "Member 'UWidget::NativeBindings' has a wrong offset!");
...
static_assert(sizeof(UPanelWidget) == 0x000118, "Wrong size on UPanelWidget");
static_assert(offsetof(UPanelWidget, Slots) == 0x000100, "Member 'UPanelWidget::Slots' has a wrong offset!");
...
static_assert(sizeof(UContentWidget) == 0x000118, "Wrong size on UContentWidget");
...
static_assert(sizeof(UScaleBox) == 0x000138, "Wrong size on UScaleBox");
static_assert(offsetof(UScaleBox, Stretch) == 0x000118, "Member 'UScaleBox::Stretch' has a wrong offset!");
static_assert(offsetof(UScaleBox, StretchDirection) == 0x000119, "Member 'UScaleBox::StretchDirection' has a wrong offset!");
static_assert(offsetof(UScaleBox, UserSpecifiedScale) == 0x00011C, "Member 'UScaleBox::UserSpecifiedScale' has a wrong offset!");
static_assert(offsetof(UScaleBox, IgnoreInheritedScale) == 0x000120, "Member 'UScaleBox::IgnoreInheritedScale' has a wrong offset!");
static_assert(offsetof(UScaleBox, bSingleLayoutPass) == 0x000121, "Member 'UScaleBox::bSingleLayoutPass' has a wrong offset!");
...
static_assert(sizeof(UAsyncTaskDownloadImage) == 0x000048, "Wrong size on UAsyncTaskDownloadImage");
static_assert(offsetof(UAsyncTaskDownloadImage, OnSuccess) == 0x000028, "Member 'UAsyncTaskDownloadImage::OnSuccess' has a wrong offset!");
static_assert(offsetof(UAsyncTaskDownloadImage, OnFail) == 0x000038, "Member 'UAsyncTaskDownloadImage::OnFail' has a wrong offset!");
...
{
public:
	struct FMargin                                Padding;                                           // 0x0118(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UBackgroundBlur) == 0x0001C0, "Wrong size on UBackgroundBlur");
static_assert(offsetof(UBackgroundBlur, Padding) == 0x000118, "Member 'UBackgroundBlur::Padding' has a wrong offset!");
static_assert(offsetof(UBackgroundBlur, HorizontalAlignment) == 0x000128, "Member 'UBackgroundBlur::HorizontalAlignment' has a wrong offset!");
static_assert(offsetof(UBackgroundBlur, VerticalAlignment) == 0x000129, "Member 'UBackgroundBlur::VerticalAlignment' has a wrong offset!");
static_assert(offsetof(UBackgroundBlur, bApplyAlphaToBlur) == 0x00012A, "Member 'UBackgroundBlur::bApplyAlphaToBlur' has a wrong offset!");
static_assert(offsetof(UBackgroundBlur, BlurStrength) == 0x00012C, "Member 'UBackgroundBlur::BlurStrength' has a wrong offset!");
static_assert(offsetof(UBackgroundBlur, bOverrideAutoRadiusCalculation) == 0x000130, "Member 'UBackgroundBlur::bOverrideAutoRadiusCalculation' has a wrong offset!");
static_assert(offsetof(UBackgroundBlur, BlurRadius) == 0x000134, "Member 'UBackgroundBlur::BlurRadius' has a wrong offset!");
static_assert(offsetof(UBackgroundBlur, LowQualityFallbackBrush) == 0x000138, "Member 'UBackgroundBlur::LowQualityFallbackBrush' has a wrong offset!");
...
static_assert(sizeof(UProgressBar) == 0x0002E0, "Wrong size on UProgressBar");
static_assert(offsetof(UProgressBar, WidgetStyle) == 0x000100, "Member 'UProgressBar::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UProgressBar, Style) == 0x000270, "Member 'UProgressBar::Style' has a wrong offset!");
static_assert(offsetof(UProgressBar, BackgroundImage) == 0x000278, "Member 'UProgressBar::BackgroundImage' has a wrong offset!");
static_assert(offsetof(UProgressBar, FillImage) == 0x000280, "Member 'UProgressBar::FillImage' has a wrong offset!");
static_assert(offsetof(UProgressBar, MarqueeImage) == 0x000288, "Member 'UProgressBar::MarqueeImage' has a wrong offset!");
static_assert(offsetof(UProgressBar, Percent) == 0x000290, "Member 'UProgressBar::Percent' has a wrong offset!");
static_assert(offsetof(UProgressBar, BarFillType) == 0x000294, "Member 'UProgressBar::BarFillType' has a wrong offset!");
static_assert(offsetof(UProgressBar, bIsMarquee) == 0x000295, "Member 'UProgressBar::bIsMarquee' has a wrong offset!");
static_assert(offsetof(UProgressBar, BorderPadding) == 0x000298, "Member 'UProgressBar::BorderPadding' has a wrong offset!");
static_assert(offsetof(UProgressBar, PercentDelegate) == 0x0002A0, "Member 'UProgressBar::PercentDelegate' has a wrong offset!");
static_assert(offsetof(UProgressBar, FillColorAndOpacity) == 0x0002B0, "Member 'UProgressBar::FillColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UProgressBar, FillColorAndOpacityDelegate) == 0x0002C0, "Member 'UProgressBar::FillColorAndOpacityDelegate' has a wrong offset!");
...
static_assert(sizeof(UPropertyBinding) == 0x000048, "Wrong size on UPropertyBinding");
...
static_assert(offsetof(UPropertyBinding, DestinationProperty) == 0x000040, "Member 'UPropertyBinding::DestinationProperty' has a wrong offset!");
...
public:
	...
	struct FMargin                                HeaderPadding;                                     // 0x02B0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	struct FMargin                                AreaPadding;                                       // 0x02C0(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UExpandableArea) == 0x000300, "Wrong size on UExpandableArea");
static_assert(offsetof(UExpandableArea, Style) == 0x000108, "Member 'UExpandableArea::Style' has a wrong offset!");
static_assert(offsetof(UExpandableArea, BorderBrush) == 0x000208, "Member 'UExpandableArea::BorderBrush' has a wrong offset!");
static_assert(offsetof(UExpandableArea, BorderColor) == 0x000280, "Member 'UExpandableArea::BorderColor' has a wrong offset!");
static_assert(offsetof(UExpandableArea, bIsExpanded) == 0x0002A8, "Member 'UExpandableArea::bIsExpanded' has a wrong offset!");
static_assert(offsetof(UExpandableArea, MaxHeight) == 0x0002AC, "Member 'UExpandableArea::MaxHeight' has a wrong offset!");
static_assert(offsetof(UExpandableArea, HeaderPadding) == 0x0002B0, "Member 'UExpandableArea::HeaderPadding' has a wrong offset!");
static_assert(offsetof(UExpandableArea, AreaPadding) == 0x0002C0, "Member 'UExpandableArea::AreaPadding' has a wrong offset!");
static_assert(offsetof(UExpandableArea, OnExpansionChanged) == 0x0002D0, "Member 'UExpandableArea::OnExpansionChanged' has a wrong offset!");
static_assert(offsetof(UExpandableArea, HeaderContent) == 0x0002E0, "Member 'UExpandableArea::HeaderContent' has a wrong offset!");
static_assert(offsetof(UExpandableArea, BodyContent) == 0x0002E8, "Member 'UExpandableArea::BodyContent' has a wrong offset!");
...
public:
	...
	struct FHitResult                             CustomHitResult;                                   // 0x0350(0x0080)(Transient, IsPlainOldData, NoDestructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	struct FVector2D                              LocalHitLocation;                                  // 0x03D0(0x0008)(Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FVector2D                              LastLocalHitLocation;                              // 0x03D8(0x0008)(Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	struct FHitResult                             LastHitResult;                                     // 0x03E8(0x0080)(Transient, IsPlainOldData, NoDestructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	bool                                          bIsHoveredWidgetInteractable;                      // 0x0468(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsHoveredWidgetFocusable;                         // 0x0469(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsHoveredWidgetHitTestVisible;                    // 0x046A(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_46B[0x5];                                      // 0x046B(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWidgetInteractionComponent) == 0x000470, "Wrong size on UWidgetInteractionComponent");
static_assert(offsetof(UWidgetInteractionComponent, OnHoveredWidgetChanged) == 0x000290, "Member 'UWidgetInteractionComponent::OnHoveredWidgetChanged' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, VirtualUserIndex) == 0x0002B0, "Member 'UWidgetInteractionComponent::VirtualUserIndex' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, PointerIndex) == 0x0002B4, "Member 'UWidgetInteractionComponent::PointerIndex' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, TraceChannel) == 0x0002B8, "Member 'UWidgetInteractionComponent::TraceChannel' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, InteractionDistance) == 0x0002BC, "Member 'UWidgetInteractionComponent::InteractionDistance' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, InteractionSource) == 0x0002C0, "Member 'UWidgetInteractionComponent::InteractionSource' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bEnableHitTesting) == 0x0002C1, "Member 'UWidgetInteractionComponent::bEnableHitTesting' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bShowDebug) == 0x0002C2, "Member 'UWidgetInteractionComponent::bShowDebug' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, DebugColor) == 0x0002C4, "Member 'UWidgetInteractionComponent::DebugColor' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, CustomHitResult) == 0x000350, "Member 'UWidgetInteractionComponent::CustomHitResult' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, LocalHitLocation) == 0x0003D0, "Member 'UWidgetInteractionComponent::LocalHitLocation' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, LastLocalHitLocation) == 0x0003D8, "Member 'UWidgetInteractionComponent::LastLocalHitLocation' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, HoveredWidgetComponent) == 0x0003E0, "Member 'UWidgetInteractionComponent::HoveredWidgetComponent' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, LastHitResult) == 0x0003E8, "Member 'UWidgetInteractionComponent::LastHitResult' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bIsHoveredWidgetInteractable) == 0x000468, "Member 'UWidgetInteractionComponent::bIsHoveredWidgetInteractable' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bIsHoveredWidgetFocusable) == 0x000469, "Member 'UWidgetInteractionComponent::bIsHoveredWidgetFocusable' has a wrong offset!");
static_assert(offsetof(UWidgetInteractionComponent, bIsHoveredWidgetHitTestVisible) == 0x00046A, "Member 'UWidgetInteractionComponent::bIsHoveredWidgetHitTestVisible' has a wrong offset!");
...
static_assert(sizeof(UBoolBinding) == 0x000048, "Wrong size on UBoolBinding");
...
static_assert(sizeof(USafeZone) == 0x000130, "Wrong size on USafeZone");
static_assert(offsetof(USafeZone, PadLeft) == 0x000118, "Member 'USafeZone::PadLeft' has a wrong offset!");
static_assert(offsetof(USafeZone, PadRight) == 0x000119, "Member 'USafeZone::PadRight' has a wrong offset!");
static_assert(offsetof(USafeZone, PadTop) == 0x00011A, "Member 'USafeZone::PadTop' has a wrong offset!");
static_assert(offsetof(USafeZone, PadBottom) == 0x00011B, "Member 'USafeZone::PadBottom' has a wrong offset!");
...
public:
	...
	struct FMargin                                Padding;                                           // 0x0140(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UBorder) == 0x000250, "Wrong size on UBorder");
static_assert(offsetof(UBorder, HorizontalAlignment) == 0x000118, "Member 'UBorder::HorizontalAlignment' has a wrong offset!");
static_assert(offsetof(UBorder, VerticalAlignment) == 0x000119, "Member 'UBorder::VerticalAlignment' has a wrong offset!");
static_assert(offsetof(UBorder, ContentColorAndOpacity) == 0x00011C, "Member 'UBorder::ContentColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UBorder, ContentColorAndOpacityDelegate) == 0x000130, "Member 'UBorder::ContentColorAndOpacityDelegate' has a wrong offset!");
static_assert(offsetof(UBorder, Padding) == 0x000140, "Member 'UBorder::Padding' has a wrong offset!");
static_assert(offsetof(UBorder, Background) == 0x000150, "Member 'UBorder::Background' has a wrong offset!");
static_assert(offsetof(UBorder, BackgroundDelegate) == 0x0001C8, "Member 'UBorder::BackgroundDelegate' has a wrong offset!");
static_assert(offsetof(UBorder, BrushColor) == 0x0001D8, "Member 'UBorder::BrushColor' has a wrong offset!");
static_assert(offsetof(UBorder, BrushColorDelegate) == 0x0001E8, "Member 'UBorder::BrushColorDelegate' has a wrong offset!");
static_assert(offsetof(UBorder, DesiredSizeScale) == 0x0001F8, "Member 'UBorder::DesiredSizeScale' has a wrong offset!");
static_assert(offsetof(UBorder, OnMouseButtonDownEvent) == 0x000200, "Member 'UBorder::OnMouseButtonDownEvent' has a wrong offset!");
static_assert(offsetof(UBorder, OnMouseButtonUpEvent) == 0x000210, "Member 'UBorder::OnMouseButtonUpEvent' has a wrong offset!");
static_assert(offsetof(UBorder, OnMouseMoveEvent) == 0x000220, "Member 'UBorder::OnMouseMoveEvent' has a wrong offset!");
static_assert(offsetof(UBorder, OnMouseDoubleClickEvent) == 0x000230, "Member 'UBorder::OnMouseDoubleClickEvent' has a wrong offset!");
...
static_assert(sizeof(UBrushBinding) == 0x000050, "Wrong size on UBrushBinding");
...
static_assert(sizeof(UHorizontalBox) == 0x000128, "Wrong size on UHorizontalBox");
...
static_assert(sizeof(UButton) == 0x0003E0, "Wrong size on UButton");
static_assert(offsetof(UButton, Style) == 0x000118, "Member 'UButton::Style' has a wrong offset!");
static_assert(offsetof(UButton, WidgetStyle) == 0x000120, "Member 'UButton::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UButton, ColorAndOpacity) == 0x000358, "Member 'UButton::ColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UButton, BackgroundColor) == 0x000368, "Member 'UButton::BackgroundColor' has a wrong offset!");
static_assert(offsetof(UButton, ClickMethod) == 0x000378, "Member 'UButton::ClickMethod' has a wrong offset!");
static_assert(offsetof(UButton, TouchMethod) == 0x000379, "Member 'UButton::TouchMethod' has a wrong offset!");
static_assert(offsetof(UButton, IsFocusable) == 0x00037A, "Member 'UButton::IsFocusable' has a wrong offset!");
static_assert(offsetof(UButton, OnClicked) == 0x000380, "Member 'UButton::OnClicked' has a wrong offset!");
static_assert(offsetof(UButton, OnPressed) == 0x000390, "Member 'UButton::OnPressed' has a wrong offset!");
static_assert(offsetof(UButton, OnReleased) == 0x0003A0, "Member 'UButton::OnReleased' has a wrong offset!");
static_assert(offsetof(UButton, OnHovered) == 0x0003B0, "Member 'UButton::OnHovered' has a wrong offset!");
static_assert(offsetof(UButton, OnUnhovered) == 0x0003C0, "Member 'UButton::OnUnhovered' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_554[0x14];                                     // 0x0554(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UScrollBar) == 0x000568, "Wrong size on UScrollBar");
static_assert(offsetof(UScrollBar, WidgetStyle) == 0x000100, "Member 'UScrollBar::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UScrollBar, Style) == 0x000540, "Member 'UScrollBar::Style' has a wrong offset!");
static_assert(offsetof(UScrollBar, bAlwaysShowScrollbar) == 0x000548, "Member 'UScrollBar::bAlwaysShowScrollbar' has a wrong offset!");
static_assert(offsetof(UScrollBar, Orientation) == 0x000549, "Member 'UScrollBar::Orientation' has a wrong offset!");
static_assert(offsetof(UScrollBar, Thickness) == 0x00054C, "Member 'UScrollBar::Thickness' has a wrong offset!");
...
static_assert(sizeof(UCanvasPanel) == 0x000128, "Wrong size on UCanvasPanel");
...
static_assert(sizeof(UInt32Binding) == 0x000048, "Wrong size on UInt32Binding");
...
static_assert(sizeof(UWrapBox) == 0x000138, "Wrong size on UWrapBox");
static_assert(offsetof(UWrapBox, InnerSlotPadding) == 0x000118, "Member 'UWrapBox::InnerSlotPadding' has a wrong offset!");
static_assert(offsetof(UWrapBox, WrapWidth) == 0x000120, "Member 'UWrapBox::WrapWidth' has a wrong offset!");
static_assert(offsetof(UWrapBox, bExplicitWrapWidth) == 0x000124, "Member 'UWrapBox::bExplicitWrapWidth' has a wrong offset!");
...
public:
	...
	struct FMargin                                Padding;                                           // 0x0674(0x0010)(Deprecated, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UCheckBox) == 0x0006D8, "Wrong size on UCheckBox");
static_assert(offsetof(UCheckBox, CheckedState) == 0x000118, "Member 'UCheckBox::CheckedState' has a wrong offset!");
static_assert(offsetof(UCheckBox, CheckedStateDelegate) == 0x000120, "Member 'UCheckBox::CheckedStateDelegate' has a wrong offset!");
static_assert(offsetof(UCheckBox, WidgetStyle) == 0x000130, "Member 'UCheckBox::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UCheckBox, Style) == 0x000620, "Member 'UCheckBox::Style' has a wrong offset!");
static_assert(offsetof(UCheckBox, UncheckedImage) == 0x000628, "Member 'UCheckBox::UncheckedImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, UncheckedHoveredImage) == 0x000630, "Member 'UCheckBox::UncheckedHoveredImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, UncheckedPressedImage) == 0x000638, "Member 'UCheckBox::UncheckedPressedImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, CheckedImage) == 0x000640, "Member 'UCheckBox::CheckedImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, CheckedHoveredImage) == 0x000648, "Member 'UCheckBox::CheckedHoveredImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, CheckedPressedImage) == 0x000650, "Member 'UCheckBox::CheckedPressedImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, UndeterminedImage) == 0x000658, "Member 'UCheckBox::UndeterminedImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, UndeterminedHoveredImage) == 0x000660, "Member 'UCheckBox::UndeterminedHoveredImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, UndeterminedPressedImage) == 0x000668, "Member 'UCheckBox::UndeterminedPressedImage' has a wrong offset!");
static_assert(offsetof(UCheckBox, HorizontalAlignment) == 0x000670, "Member 'UCheckBox::HorizontalAlignment' has a wrong offset!");
static_assert(offsetof(UCheckBox, Padding) == 0x000674, "Member 'UCheckBox::Padding' has a wrong offset!");
static_assert(offsetof(UCheckBox, BorderBackgroundColor) == 0x000688, "Member 'UCheckBox::BorderBackgroundColor' has a wrong offset!");
static_assert(offsetof(UCheckBox, IsFocusable) == 0x0006B0, "Member 'UCheckBox::IsFocusable' has a wrong offset!");
static_assert(offsetof(UCheckBox, OnCheckStateChanged) == 0x0006B8, "Member 'UCheckBox::OnCheckStateChanged' has a wrong offset!");
...
static_assert(sizeof(UCheckedStateBinding) == 0x000050, "Wrong size on UCheckedStateBinding");
...
static_assert(sizeof(UCircularThrobber) == 0x0001A8, "Wrong size on UCircularThrobber");
static_assert(offsetof(UCircularThrobber, NumberOfPieces) == 0x000100, "Member 'UCircularThrobber::NumberOfPieces' has a wrong offset!");
static_assert(offsetof(UCircularThrobber, Period) == 0x000104, "Member 'UCircularThrobber::Period' has a wrong offset!");
static_assert(offsetof(UCircularThrobber, Radius) == 0x000108, "Member 'UCircularThrobber::Radius' has a wrong offset!");
static_assert(offsetof(UCircularThrobber, PieceImage) == 0x000110, "Member 'UCircularThrobber::PieceImage' has a wrong offset!");
static_assert(offsetof(UCircularThrobber, Image) == 0x000118, "Member 'UCircularThrobber::Image' has a wrong offset!");
static_assert(offsetof(UCircularThrobber, bEnableRadius) == 0x000190, "Member 'UCircularThrobber::bEnableRadius' has a wrong offset!");
...
static_assert(sizeof(UColorBinding) == 0x000050, "Wrong size on UColorBinding");
...
static_assert(sizeof(UMenuAnchor) == 0x000158, "Wrong size on UMenuAnchor");
static_assert(offsetof(UMenuAnchor, MenuClass) == 0x000118, "Member 'UMenuAnchor::MenuClass' has a wrong offset!");
static_assert(offsetof(UMenuAnchor, OnGetMenuContentEvent) == 0x000120, "Member 'UMenuAnchor::OnGetMenuContentEvent' has a wrong offset!");
static_assert(offsetof(UMenuAnchor, Placement) == 0x000130, "Member 'UMenuAnchor::Placement' has a wrong offset!");
static_assert(offsetof(UMenuAnchor, ShouldDeferPaintingAfterWindowContent) == 0x000131, "Member 'UMenuAnchor::ShouldDeferPaintingAfterWindowContent' has a wrong offset!");
static_assert(offsetof(UMenuAnchor, UseApplicationMenuStack) == 0x000132, "Member 'UMenuAnchor::UseApplicationMenuStack' has a wrong offset!");
static_assert(offsetof(UMenuAnchor, OnMenuOpenChanged) == 0x000138, "Member 'UMenuAnchor::OnMenuOpenChanged' has a wrong offset!");
...
static_assert(sizeof(UComboBox) == 0x000138, "Wrong size on UComboBox");
static_assert(offsetof(UComboBox, Items) == 0x000100, "Member 'UComboBox::Items' has a wrong offset!");
static_assert(offsetof(UComboBox, OnGenerateWidgetEvent) == 0x000110, "Member 'UComboBox::OnGenerateWidgetEvent' has a wrong offset!");
static_assert(offsetof(UComboBox, bIsFocusable) == 0x000120, "Member 'UComboBox::bIsFocusable' has a wrong offset!");
...
public:
	...
	struct FMargin                                ContentPadding;                                    // 0x0A90(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_B60[0x40];                                     // 0x0B60(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UComboBoxString) == 0x000BA0, "Wrong size on UComboBoxString");
static_assert(offsetof(UComboBoxString, DefaultOptions) == 0x000100, "Member 'UComboBoxString::DefaultOptions' has a wrong offset!");
static_assert(offsetof(UComboBoxString, SelectedOption) == 0x000110, "Member 'UComboBoxString::SelectedOption' has a wrong offset!");
static_assert(offsetof(UComboBoxString, WidgetStyle) == 0x000120, "Member 'UComboBoxString::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UComboBoxString, ItemStyle) == 0x000498, "Member 'UComboBoxString::ItemStyle' has a wrong offset!");
static_assert(offsetof(UComboBoxString, ContentPadding) == 0x000A90, "Member 'UComboBoxString::ContentPadding' has a wrong offset!");
static_assert(offsetof(UComboBoxString, MaxListHeight) == 0x000AA0, "Member 'UComboBoxString::MaxListHeight' has a wrong offset!");
static_assert(offsetof(UComboBoxString, HasDownArrow) == 0x000AA4, "Member 'UComboBoxString::HasDownArrow' has a wrong offset!");
static_assert(offsetof(UComboBoxString, EnableGamepadNavigationMode) == 0x000AA5, "Member 'UComboBoxString::EnableGamepadNavigationMode' has a wrong offset!");
static_assert(offsetof(UComboBoxString, Font) == 0x000AA8, "Member 'UComboBoxString::Font' has a wrong offset!");
static_assert(offsetof(UComboBoxString, ForegroundColor) == 0x000B00, "Member 'UComboBoxString::ForegroundColor' has a wrong offset!");
static_assert(offsetof(UComboBoxString, bIsFocusable) == 0x000B28, "Member 'UComboBoxString::bIsFocusable' has a wrong offset!");
static_assert(offsetof(UComboBoxString, OnGenerateWidgetEvent) == 0x000B30, "Member 'UComboBoxString::OnGenerateWidgetEvent' has a wrong offset!");
static_assert(offsetof(UComboBoxString, OnSelectionChanged) == 0x000B40, "Member 'UComboBoxString::OnSelectionChanged' has a wrong offset!");
static_assert(offsetof(UComboBoxString, OnOpening) == 0x000B50, "Member 'UComboBoxString::OnOpening' has a wrong offset!");
...
public:
	...
	struct FShapedTextOptions                     ShapedTextOptions;                                 // 0x03F0(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableText) == 0x000428, "Wrong size on UEditableText");
static_assert(offsetof(UEditableText, Text) == 0x000100, "Member 'UEditableText::Text' has a wrong offset!");
static_assert(offsetof(UEditableText, TextDelegate) == 0x000118, "Member 'UEditableText::TextDelegate' has a wrong offset!");
static_assert(offsetof(UEditableText, HintText) == 0x000128, "Member 'UEditableText::HintText' has a wrong offset!");
static_assert(offsetof(UEditableText, HintTextDelegate) == 0x000140, "Member 'UEditableText::HintTextDelegate' has a wrong offset!");
static_assert(offsetof(UEditableText, WidgetStyle) == 0x000150, "Member 'UEditableText::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UEditableText, Style) == 0x000340, "Member 'UEditableText::Style' has a wrong offset!");
static_assert(offsetof(UEditableText, BackgroundImageSelected) == 0x000348, "Member 'UEditableText::BackgroundImageSelected' has a wrong offset!");
static_assert(offsetof(UEditableText, BackgroundImageComposing) == 0x000350, "Member 'UEditableText::BackgroundImageComposing' has a wrong offset!");
static_assert(offsetof(UEditableText, CaretImage) == 0x000358, "Member 'UEditableText::CaretImage' has a wrong offset!");
static_assert(offsetof(UEditableText, Font) == 0x000360, "Member 'UEditableText::Font' has a wrong offset!");
static_assert(offsetof(UEditableText, ColorAndOpacity) == 0x0003B8, "Member 'UEditableText::ColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UEditableText, IsReadOnly) == 0x0003E0, "Member 'UEditableText::IsReadOnly' has a wrong offset!");
static_assert(offsetof(UEditableText, IsPassword) == 0x0003E1, "Member 'UEditableText::IsPassword' has a wrong offset!");
static_assert(offsetof(UEditableText, MinimumDesiredWidth) == 0x0003E4, "Member 'UEditableText::MinimumDesiredWidth' has a wrong offset!");
static_assert(offsetof(UEditableText, IsCaretMovedWhenGainFocus) == 0x0003E8, "Member 'UEditableText::IsCaretMovedWhenGainFocus' has a wrong offset!");
static_assert(offsetof(UEditableText, SelectAllTextWhenFocused) == 0x0003E9, "Member 'UEditableText::SelectAllTextWhenFocused' has a wrong offset!");
static_assert(offsetof(UEditableText, RevertTextOnEscape) == 0x0003EA, "Member 'UEditableText::RevertTextOnEscape' has a wrong offset!");
static_assert(offsetof(UEditableText, ClearKeyboardFocusOnCommit) == 0x0003EB, "Member 'UEditableText::ClearKeyboardFocusOnCommit' has a wrong offset!");
static_assert(offsetof(UEditableText, SelectAllTextOnCommit) == 0x0003EC, "Member 'UEditableText::SelectAllTextOnCommit' has a wrong offset!");
static_assert(offsetof(UEditableText, AllowContextMenu) == 0x0003ED, "Member 'UEditableText::AllowContextMenu' has a wrong offset!");
static_assert(offsetof(UEditableText, KeyboardType) == 0x0003EE, "Member 'UEditableText::KeyboardType' has a wrong offset!");
static_assert(offsetof(UEditableText, ShapedTextOptions) == 0x0003F0, "Member 'UEditableText::ShapedTextOptions' has a wrong offset!");
static_assert(offsetof(UEditableText, OnTextChanged) == 0x0003F8, "Member 'UEditableText::OnTextChanged' has a wrong offset!");
static_assert(offsetof(UEditableText, OnTextCommitted) == 0x000408, "Member 'UEditableText::OnTextCommitted' has a wrong offset!");

// Class UMG.EditableTextBox
// 0x0860 (0x0960 - 0x0100)
...
public:
	...
	struct FMargin                                Padding;                                           // 0x0910(0x0010)(Deprecated, NoDestructor, NativeAccessSpecifierPublic)
	...
	struct FShapedTextOptions                     ShapedTextOptions;                                 // 0x0928(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	UMulticastDelegateProperty_                   OnTextChanged;                                     // 0x0930(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	UMulticastDelegateProperty_                   OnTextCommitted;                                   // 0x0940(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UEditableTextBox) == 0x000960, "Wrong size on UEditableTextBox");
static_assert(offsetof(UEditableTextBox, Text) == 0x000100, "Member 'UEditableTextBox::Text' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, TextDelegate) == 0x000118, "Member 'UEditableTextBox::TextDelegate' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, WidgetStyle) == 0x000128, "Member 'UEditableTextBox::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, Style) == 0x000850, "Member 'UEditableTextBox::Style' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, HintText) == 0x000858, "Member 'UEditableTextBox::HintText' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, HintTextDelegate) == 0x000870, "Member 'UEditableTextBox::HintTextDelegate' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, Font) == 0x000880, "Member 'UEditableTextBox::Font' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ForegroundColor) == 0x0008D8, "Member 'UEditableTextBox::ForegroundColor' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, BackgroundColor) == 0x0008E8, "Member 'UEditableTextBox::BackgroundColor' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ReadOnlyForegroundColor) == 0x0008F8, "Member 'UEditableTextBox::ReadOnlyForegroundColor' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, IsReadOnly) == 0x000908, "Member 'UEditableTextBox::IsReadOnly' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, IsPassword) == 0x000909, "Member 'UEditableTextBox::IsPassword' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, MinimumDesiredWidth) == 0x00090C, "Member 'UEditableTextBox::MinimumDesiredWidth' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, Padding) == 0x000910, "Member 'UEditableTextBox::Padding' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, IsCaretMovedWhenGainFocus) == 0x000920, "Member 'UEditableTextBox::IsCaretMovedWhenGainFocus' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, SelectAllTextWhenFocused) == 0x000921, "Member 'UEditableTextBox::SelectAllTextWhenFocused' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, RevertTextOnEscape) == 0x000922, "Member 'UEditableTextBox::RevertTextOnEscape' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ClearKeyboardFocusOnCommit) == 0x000923, "Member 'UEditableTextBox::ClearKeyboardFocusOnCommit' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, SelectAllTextOnCommit) == 0x000924, "Member 'UEditableTextBox::SelectAllTextOnCommit' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, AllowContextMenu) == 0x000925, "Member 'UEditableTextBox::AllowContextMenu' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, KeyboardType) == 0x000926, "Member 'UEditableTextBox::KeyboardType' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, ShapedTextOptions) == 0x000928, "Member 'UEditableTextBox::ShapedTextOptions' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, OnTextChanged) == 0x000930, "Member 'UEditableTextBox::OnTextChanged' has a wrong offset!");
static_assert(offsetof(UEditableTextBox, OnTextCommitted) == 0x000940, "Member 'UEditableTextBox::OnTextCommitted' has a wrong offset!");
...
static_assert(sizeof(UFloatBinding) == 0x000048, "Wrong size on UFloatBinding");
...
static_assert(sizeof(UGridPanel) == 0x000148, "Wrong size on UGridPanel");
static_assert(offsetof(UGridPanel, ColumnFill) == 0x000118, "Member 'UGridPanel::ColumnFill' has a wrong offset!");
static_assert(offsetof(UGridPanel, RowFill) == 0x000128, "Member 'UGridPanel::RowFill' has a wrong offset!");
...
static_assert(sizeof(UImage) == 0x0001C8, "Wrong size on UImage");
static_assert(offsetof(UImage, Brush) == 0x000100, "Member 'UImage::Brush' has a wrong offset!");
static_assert(offsetof(UImage, BrushDelegate) == 0x000178, "Member 'UImage::BrushDelegate' has a wrong offset!");
static_assert(offsetof(UImage, ColorAndOpacity) == 0x000188, "Member 'UImage::ColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UImage, ColorAndOpacityDelegate) == 0x000198, "Member 'UImage::ColorAndOpacityDelegate' has a wrong offset!");
static_assert(offsetof(UImage, OnMouseButtonDownEvent) == 0x0001A8, "Member 'UImage::OnMouseButtonDownEvent' has a wrong offset!");
...
public:
	...
	struct FMargin                                Margin;                                            // 0x0578(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UInputKeySelector) == 0x000610, "Wrong size on UInputKeySelector");
static_assert(offsetof(UInputKeySelector, WidgetStyle) == 0x000100, "Member 'UInputKeySelector::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, TextStyle) == 0x000338, "Member 'UInputKeySelector::TextStyle' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, SelectedKey) == 0x000500, "Member 'UInputKeySelector::SelectedKey' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, Font) == 0x000520, "Member 'UInputKeySelector::Font' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, Margin) == 0x000578, "Member 'UInputKeySelector::Margin' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, ColorAndOpacity) == 0x000588, "Member 'UInputKeySelector::ColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, KeySelectionText) == 0x000598, "Member 'UInputKeySelector::KeySelectionText' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, NoKeySpecifiedText) == 0x0005B0, "Member 'UInputKeySelector::NoKeySpecifiedText' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, bAllowModifierKeys) == 0x0005C8, "Member 'UInputKeySelector::bAllowModifierKeys' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, bAllowGamepadKeys) == 0x0005C9, "Member 'UInputKeySelector::bAllowGamepadKeys' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, EscapeKeys) == 0x0005D0, "Member 'UInputKeySelector::EscapeKeys' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, OnKeySelected) == 0x0005E0, "Member 'UInputKeySelector::OnKeySelected' has a wrong offset!");
static_assert(offsetof(UInputKeySelector, OnIsSelectingKeyChanged) == 0x0005F0, "Member 'UInputKeySelector::OnIsSelectingKeyChanged' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_11A[0x16];                                     // 0x011A(0x0016)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UInvalidationBox) == 0x000130, "Wrong size on UInvalidationBox");
static_assert(offsetof(UInvalidationBox, bCanCache) == 0x000118, "Member 'UInvalidationBox::bCanCache' has a wrong offset!");
static_assert(offsetof(UInvalidationBox, CacheRelativeTransforms) == 0x000119, "Member 'UInvalidationBox::CacheRelativeTransforms' has a wrong offset!");
...
static_assert(alignof(UTableViewBase) == 0x000008, "Wrong alignment on UTableViewBase");
static_assert(sizeof(UTableViewBase) == 0x000100, "Wrong size on UTableViewBase");
...
static_assert(sizeof(UListView) == 0x000140, "Wrong size on UListView");
static_assert(offsetof(UListView, ItemHeight) == 0x000100, "Member 'UListView::ItemHeight' has a wrong offset!");
static_assert(offsetof(UListView, Items) == 0x000108, "Member 'UListView::Items' has a wrong offset!");
static_assert(offsetof(UListView, SelectionMode) == 0x000118, "Member 'UListView::SelectionMode' has a wrong offset!");
static_assert(offsetof(UListView, OnGenerateRowEvent) == 0x000120, "Member 'UListView::OnGenerateRowEvent' has a wrong offset!");
...
static_assert(sizeof(UMouseCursorBinding) == 0x000048, "Wrong size on UMouseCursorBinding");
...
static_assert(sizeof(UMovieScene2DTransformSection) == 0x000430, "Wrong size on UMovieScene2DTransformSection");
static_assert(offsetof(UMovieScene2DTransformSection, Translation) == 0x000118, "Member 'UMovieScene2DTransformSection::Translation' has a wrong offset!");
static_assert(offsetof(UMovieScene2DTransformSection, Rotation) == 0x0001F8, "Member 'UMovieScene2DTransformSection::Rotation' has a wrong offset!");
static_assert(offsetof(UMovieScene2DTransformSection, Scale) == 0x000268, "Member 'UMovieScene2DTransformSection::Scale' has a wrong offset!");
static_assert(offsetof(UMovieScene2DTransformSection, Shear) == 0x000348, "Member 'UMovieScene2DTransformSection::Shear' has a wrong offset!");
...
static_assert(sizeof(UMovieScene2DTransformTrack) == 0x0000E0, "Wrong size on UMovieScene2DTransformTrack");
...
static_assert(sizeof(UMovieSceneMarginSection) == 0x0002E0, "Wrong size on UMovieSceneMarginSection");
static_assert(offsetof(UMovieSceneMarginSection, TopCurve) == 0x000118, "Member 'UMovieSceneMarginSection::TopCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneMarginSection, LeftCurve) == 0x000188, "Member 'UMovieSceneMarginSection::LeftCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneMarginSection, RightCurve) == 0x0001F8, "Member 'UMovieSceneMarginSection::RightCurve' has a wrong offset!");
static_assert(offsetof(UMovieSceneMarginSection, BottomCurve) == 0x000268, "Member 'UMovieSceneMarginSection::BottomCurve' has a wrong offset!");
...
static_assert(sizeof(UMovieSceneMarginTrack) == 0x0000E0, "Wrong size on UMovieSceneMarginTrack");
...
static_assert(sizeof(UMovieSceneWidgetMaterialTrack) == 0x0000E0, "Wrong size on UMovieSceneWidgetMaterialTrack");
static_assert(offsetof(UMovieSceneWidgetMaterialTrack, BrushPropertyNamePath) == 0x0000C8, "Member 'UMovieSceneWidgetMaterialTrack::BrushPropertyNamePath' has a wrong offset!");
static_assert(offsetof(UMovieSceneWidgetMaterialTrack, TrackName) == 0x0000D8, "Member 'UMovieSceneWidgetMaterialTrack::TrackName' has a wrong offset!");
...
public:
	...
	struct FMargin                                Margin;                                            // 0x0114(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, AdvancedDisplay, Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UTextLayoutWidget, ShapedTextOptions) == 0x000100, "Member 'UTextLayoutWidget::ShapedTextOptions' has a wrong offset!");
static_assert(offsetof(UTextLayoutWidget, Justification) == 0x000108, "Member 'UTextLayoutWidget::Justification' has a wrong offset!");
static_assert(offsetof(UTextLayoutWidget, AutoWrapText) == 0x000109, "Member 'UTextLayoutWidget::AutoWrapText' has a wrong offset!");
static_assert(offsetof(UTextLayoutWidget, WrapTextAt) == 0x00010C, "Member 'UTextLayoutWidget::WrapTextAt' has a wrong offset!");
static_assert(offsetof(UTextLayoutWidget, WrappingPolicy) == 0x000110, "Member 'UTextLayoutWidget::WrappingPolicy' has a wrong offset!");
...
public:
	...
	bool                                          AllowContextMenu;                                  // 0x0390(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UMultiLineEditableText) == 0x0003C8, "Wrong size on UMultiLineEditableText");
...
static_assert(offsetof(UMultiLineEditableText, bIsReadOnly) == 0x000330, "Member 'UMultiLineEditableText::bIsReadOnly' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableText, Font) == 0x000338, "Member 'UMultiLineEditableText::Font' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableText, AllowContextMenu) == 0x000390, "Member 'UMultiLineEditableText::AllowContextMenu' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableText, OnTextChanged) == 0x000398, "Member 'UMultiLineEditableText::OnTextChanged' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableText, OnTextCommitted) == 0x0003A8, "Member 'UMultiLineEditableText::OnTextCommitted' has a wrong offset!");
...
static_assert(sizeof(UMultiLineEditableTextBox) == 0x000B20, "Wrong size on UMultiLineEditableTextBox");
...
static_assert(offsetof(UMultiLineEditableTextBox, TextStyle) == 0x000890, "Member 'UMultiLineEditableTextBox::TextStyle' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, bIsReadOnly) == 0x000A58, "Member 'UMultiLineEditableTextBox::bIsReadOnly' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, AllowContextMenu) == 0x000A59, "Member 'UMultiLineEditableTextBox::AllowContextMenu' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, Style) == 0x000A60, "Member 'UMultiLineEditableTextBox::Style' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, Font) == 0x000A68, "Member 'UMultiLineEditableTextBox::Font' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, ForegroundColor) == 0x000AC0, "Member 'UMultiLineEditableTextBox::ForegroundColor' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, BackgroundColor) == 0x000AD0, "Member 'UMultiLineEditableTextBox::BackgroundColor' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, ReadOnlyForegroundColor) == 0x000AE0, "Member 'UMultiLineEditableTextBox::ReadOnlyForegroundColor' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, OnTextChanged) == 0x000AF0, "Member 'UMultiLineEditableTextBox::OnTextChanged' has a wrong offset!");
static_assert(offsetof(UMultiLineEditableTextBox, OnTextCommitted) == 0x000B00, "Member 'UMultiLineEditableTextBox::OnTextCommitted' has a wrong offset!");
...
static_assert(sizeof(UNamedSlot) == 0x000128, "Wrong size on UNamedSlot");
...
static_assert(sizeof(UNativeWidgetHost) == 0x000110, "Wrong size on UNativeWidgetHost");
...
static_assert(sizeof(UOverlay) == 0x000128, "Wrong size on UOverlay");
...
public:
	...
	struct FMargin                                Padding;                                           // 0x0040(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	EHorizontalAlignment                          HorizontalAlignment;                               // 0x0050(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EVerticalAlignment                            VerticalAlignment;                                 // 0x0051(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(URetainerBox) == 0x000148, "Wrong size on URetainerBox");
static_assert(offsetof(URetainerBox, RenderOnInvalidation) == 0x000118, "Member 'URetainerBox::RenderOnInvalidation' has a wrong offset!");
static_assert(offsetof(URetainerBox, RenderOnPhase) == 0x000119, "Member 'URetainerBox::RenderOnPhase' has a wrong offset!");
static_assert(offsetof(URetainerBox, Phase) == 0x00011C, "Member 'URetainerBox::Phase' has a wrong offset!");
static_assert(offsetof(URetainerBox, PhaseCount) == 0x000120, "Member 'URetainerBox::PhaseCount' has a wrong offset!");
static_assert(offsetof(URetainerBox, EffectMaterial) == 0x000128, "Member 'URetainerBox::EffectMaterial' has a wrong offset!");
static_assert(offsetof(URetainerBox, TextureParameter) == 0x000130, "Member 'URetainerBox::TextureParameter' has a wrong offset!");
...
public:
	...
	struct FLinearColor                           Color;                                             // 0x01A8(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(URichTextBlock) == 0x0003A0, "Wrong size on URichTextBlock");
static_assert(offsetof(URichTextBlock, Text) == 0x000128, "Member 'URichTextBlock::Text' has a wrong offset!");
static_assert(offsetof(URichTextBlock, TextDelegate) == 0x000140, "Member 'URichTextBlock::TextDelegate' has a wrong offset!");
static_assert(offsetof(URichTextBlock, Font) == 0x000150, "Member 'URichTextBlock::Font' has a wrong offset!");
static_assert(offsetof(URichTextBlock, Color) == 0x0001A8, "Member 'URichTextBlock::Color' has a wrong offset!");
static_assert(offsetof(URichTextBlock, Decorators) == 0x0001B8, "Member 'URichTextBlock::Decorators' has a wrong offset!");
...
static_assert(offsetof(URichTextBlockDecorator, bReveal) == 0x000028, "Member 'URichTextBlockDecorator::bReveal' has a wrong offset!");
static_assert(offsetof(URichTextBlockDecorator, RevealedIndex) == 0x00002C, "Member 'URichTextBlockDecorator::RevealedIndex' has a wrong offset!");
...
static_assert(sizeof(UScrollBox) == 0x000790, "Wrong size on UScrollBox");
static_assert(offsetof(UScrollBox, WidgetStyle) == 0x000118, "Member 'UScrollBox::WidgetStyle' has a wrong offset!");
static_assert(offsetof(UScrollBox, WidgetBarStyle) == 0x000300, "Member 'UScrollBox::WidgetBarStyle' has a wrong offset!");
static_assert(offsetof(UScrollBox, Style) == 0x000740, "Member 'UScrollBox::Style' has a wrong offset!");
static_assert(offsetof(UScrollBox, BarStyle) == 0x000748, "Member 'UScrollBox::BarStyle' has a wrong offset!");
static_assert(offsetof(UScrollBox, Orientation) == 0x000750, "Member 'UScrollBox::Orientation' has a wrong offset!");
static_assert(offsetof(UScrollBox, ScrollBarVisibility) == 0x000751, "Member 'UScrollBox::ScrollBarVisibility' has a wrong offset!");
static_assert(offsetof(UScrollBox, ConsumeMouseWheel) == 0x000752, "Member 'UScrollBox::ConsumeMouseWheel' has a wrong offset!");
static_assert(offsetof(UScrollBox, ScrollbarThickness) == 0x000754, "Member 'UScrollBox::ScrollbarThickness' has a wrong offset!");
static_assert(offsetof(UScrollBox, AlwaysShowScrollbar) == 0x00075C, "Member 'UScrollBox::AlwaysShowScrollbar' has a wrong offset!");
static_assert(offsetof(UScrollBox, AllowOverscroll) == 0x00075D, "Member 'UScrollBox::AllowOverscroll' has a wrong offset!");
static_assert(offsetof(UScrollBox, NavigationDestination) == 0x00075E, "Member 'UScrollBox::NavigationDestination' has a wrong offset!");
static_assert(offsetof(UScrollBox, NavigationScrollPadding) == 0x000760, "Member 'UScrollBox::NavigationScrollPadding' has a wrong offset!");
static_assert(offsetof(UScrollBox, bAllowRightClickDragScrolling) == 0x000764, "Member 'UScrollBox::bAllowRightClickDragScrolling' has a wrong offset!");
static_assert(offsetof(UScrollBox, OnUserScrolled) == 0x000768, "Member 'UScrollBox::OnUserScrolled' has a wrong offset!");
...
static_assert(sizeof(USizeBox) == 0x000148, "Wrong size on USizeBox");
static_assert(offsetof(USizeBox, WidthOverride) == 0x00011C, "Member 'USizeBox::WidthOverride' has a wrong offset!");
static_assert(offsetof(USizeBox, HeightOverride) == 0x000120, "Member 'USizeBox::HeightOverride' has a wrong offset!");
static_assert(offsetof(USizeBox, MinDesiredWidth) == 0x000124, "Member 'USizeBox::MinDesiredWidth' has a wrong offset!");
static_assert(offsetof(USizeBox, MinDesiredHeight) == 0x000128, "Member 'USizeBox::MinDesiredHeight' has a wrong offset!");
static_assert(offsetof(USizeBox, MaxDesiredWidth) == 0x00012C, "Member 'USizeBox::MaxDesiredWidth' has a wrong offset!");
static_assert(offsetof(USizeBox, MaxDesiredHeight) == 0x000130, "Member 'USizeBox::MaxDesiredHeight' has a wrong offset!");
static_assert(offsetof(USizeBox, MaxAspectRatio) == 0x000134, "Member 'USizeBox::MaxAspectRatio' has a wrong offset!");
...
static_assert(alignof(USlateDataSheet) == 0x000008, "Wrong alignment on USlateDataSheet");
static_assert(sizeof(USlateDataSheet) == 0x000430, "Wrong size on USlateDataSheet");
static_assert(offsetof(USlateDataSheet, DataTexture) == 0x000028, "Member 'USlateDataSheet::DataTexture' has a wrong offset!");
...
static_assert(sizeof(USlider) == 0x000398, "Wrong size on USlider");
static_assert(offsetof(USlider, Value) == 0x000100, "Member 'USlider::Value' has a wrong offset!");
static_assert(offsetof(USlider, ValueDelegate) == 0x000108, "Member 'USlider::ValueDelegate' has a wrong offset!");
static_assert(offsetof(USlider, WidgetStyle) == 0x000118, "Member 'USlider::WidgetStyle' has a wrong offset!");
static_assert(offsetof(USlider, Orientation) == 0x000308, "Member 'USlider::Orientation' has a wrong offset!");
static_assert(offsetof(USlider, SliderBarColor) == 0x00030C, "Member 'USlider::SliderBarColor' has a wrong offset!");
static_assert(offsetof(USlider, SliderHandleColor) == 0x00031C, "Member 'USlider::SliderHandleColor' has a wrong offset!");
static_assert(offsetof(USlider, IndentHandle) == 0x00032C, "Member 'USlider::IndentHandle' has a wrong offset!");
static_assert(offsetof(USlider, Locked) == 0x00032D, "Member 'USlider::Locked' has a wrong offset!");
static_assert(offsetof(USlider, StepSize) == 0x000330, "Member 'USlider::StepSize' has a wrong offset!");
static_assert(offsetof(USlider, IsFocusable) == 0x000334, "Member 'USlider::IsFocusable' has a wrong offset!");
static_assert(offsetof(USlider, OnMouseCaptureBegin) == 0x000338, "Member 'USlider::OnMouseCaptureBegin' has a wrong offset!");
static_assert(offsetof(USlider, OnMouseCaptureEnd) == 0x000348, "Member 'USlider::OnMouseCaptureEnd' has a wrong offset!");
static_assert(offsetof(USlider, OnControllerCaptureBegin) == 0x000358, "Member 'USlider::OnControllerCaptureBegin' has a wrong offset!");
static_assert(offsetof(USlider, OnControllerCaptureEnd) == 0x000368, "Member 'USlider::OnControllerCaptureEnd' has a wrong offset!");
static_assert(offsetof(USlider, OnValueChanged) == 0x000378, "Member 'USlider::OnValueChanged' has a wrong offset!");
...
static_assert(sizeof(USpacer) == 0x000118, "Wrong size on USpacer");
static_assert(offsetof(USpacer, Size) == 0x000100, "Member 'USpacer::Size' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4A4[0x14];                                     // 0x04A4(0x0014)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USpinBox) == 0x0004B8, "Wrong size on USpinBox");
static_assert(offsetof(USpinBox, Value) == 0x000100, "Member 'USpinBox::Value' has a wrong offset!");
static_assert(offsetof(USpinBox, ValueDelegate) == 0x000108, "Member 'USpinBox::ValueDelegate' has a wrong offset!");
static_assert(offsetof(USpinBox, WidgetStyle) == 0x000118, "Member 'USpinBox::WidgetStyle' has a wrong offset!");
static_assert(offsetof(USpinBox, Style) == 0x0003B0, "Member 'USpinBox::Style' has a wrong offset!");
static_assert(offsetof(USpinBox, Delta) == 0x0003B8, "Member 'USpinBox::Delta' has a wrong offset!");
static_assert(offsetof(USpinBox, SliderExponent) == 0x0003BC, "Member 'USpinBox::SliderExponent' has a wrong offset!");
static_assert(offsetof(USpinBox, Font) == 0x0003C0, "Member 'USpinBox::Font' has a wrong offset!");
static_assert(offsetof(USpinBox, Justification) == 0x000418, "Member 'USpinBox::Justification' has a wrong offset!");
static_assert(offsetof(USpinBox, MinDesiredWidth) == 0x00041C, "Member 'USpinBox::MinDesiredWidth' has a wrong offset!");
static_assert(offsetof(USpinBox, ClearKeyboardFocusOnCommit) == 0x000420, "Member 'USpinBox::ClearKeyboardFocusOnCommit' has a wrong offset!");
static_assert(offsetof(USpinBox, SelectAllTextOnCommit) == 0x000421, "Member 'USpinBox::SelectAllTextOnCommit' has a wrong offset!");
static_assert(offsetof(USpinBox, ForegroundColor) == 0x000428, "Member 'USpinBox::ForegroundColor' has a wrong offset!");
static_assert(offsetof(USpinBox, OnValueChanged) == 0x000450, "Member 'USpinBox::OnValueChanged' has a wrong offset!");
static_assert(offsetof(USpinBox, OnValueCommitted) == 0x000460, "Member 'USpinBox::OnValueCommitted' has a wrong offset!");
static_assert(offsetof(USpinBox, OnBeginSliderMovement) == 0x000470, "Member 'USpinBox::OnBeginSliderMovement' has a wrong offset!");
static_assert(offsetof(USpinBox, OnEndSliderMovement) == 0x000480, "Member 'USpinBox::OnEndSliderMovement' has a wrong offset!");
static_assert(offsetof(USpinBox, MinValue) == 0x000494, "Member 'USpinBox::MinValue' has a wrong offset!");
static_assert(offsetof(USpinBox, MaxValue) == 0x000498, "Member 'USpinBox::MaxValue' has a wrong offset!");
static_assert(offsetof(USpinBox, MinSliderValue) == 0x00049C, "Member 'USpinBox::MinSliderValue' has a wrong offset!");
static_assert(offsetof(USpinBox, MaxSliderValue) == 0x0004A0, "Member 'USpinBox::MaxSliderValue' has a wrong offset!");
...
static_assert(sizeof(UTextBinding) == 0x000050, "Wrong size on UTextBinding");
...
static_assert(sizeof(UTextBlock) == 0x000220, "Wrong size on UTextBlock");
...
static_assert(offsetof(UTextBlock, ShadowOffset) == 0x0001E0, "Member 'UTextBlock::ShadowOffset' has a wrong offset!");
static_assert(offsetof(UTextBlock, ShadowColorAndOpacity) == 0x0001E8, "Member 'UTextBlock::ShadowColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UTextBlock, ShadowColorAndOpacityDelegate) == 0x0001F8, "Member 'UTextBlock::ShadowColorAndOpacityDelegate' has a wrong offset!");
static_assert(offsetof(UTextBlock, MinDesiredWidth) == 0x000208, "Member 'UTextBlock::MinDesiredWidth' has a wrong offset!");
static_assert(offsetof(UTextBlock, bWrapWithInvalidationPanel) == 0x00020C, "Member 'UTextBlock::bWrapWithInvalidationPanel' has a wrong offset!");
...
static_assert(sizeof(UThrobber) == 0x000198, "Wrong size on UThrobber");
static_assert(offsetof(UThrobber, NumberOfPieces) == 0x000100, "Member 'UThrobber::NumberOfPieces' has a wrong offset!");
static_assert(offsetof(UThrobber, bAnimateHorizontally) == 0x000104, "Member 'UThrobber::bAnimateHorizontally' has a wrong offset!");
static_assert(offsetof(UThrobber, bAnimateVertically) == 0x000105, "Member 'UThrobber::bAnimateVertically' has a wrong offset!");
static_assert(offsetof(UThrobber, bAnimateOpacity) == 0x000106, "Member 'UThrobber::bAnimateOpacity' has a wrong offset!");
static_assert(offsetof(UThrobber, PieceImage) == 0x000108, "Member 'UThrobber::PieceImage' has a wrong offset!");
static_assert(offsetof(UThrobber, Image) == 0x000110, "Member 'UThrobber::Image' has a wrong offset!");
...
static_assert(sizeof(UTileView) == 0x000140, "Wrong size on UTileView");
static_assert(offsetof(UTileView, ItemWidth) == 0x000100, "Member 'UTileView::ItemWidth' has a wrong offset!");
static_assert(offsetof(UTileView, ItemHeight) == 0x000104, "Member 'UTileView::ItemHeight' has a wrong offset!");
static_assert(offsetof(UTileView, Items) == 0x000108, "Member 'UTileView::Items' has a wrong offset!");
static_assert(offsetof(UTileView, SelectionMode) == 0x000118, "Member 'UTileView::SelectionMode' has a wrong offset!");
static_assert(offsetof(UTileView, OnGenerateTileEvent) == 0x000120, "Member 'UTileView::OnGenerateTileEvent' has a wrong offset!");
...
static_assert(sizeof(UUMGSequencePlayer) == 0x000780, "Wrong size on UUMGSequencePlayer");
...
{
public:
	struct FMargin                                SlotPadding;                                       // 0x0118(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UUniformGridPanel) == 0x000140, "Wrong size on UUniformGridPanel");
static_assert(offsetof(UUniformGridPanel, SlotPadding) == 0x000118, "Member 'UUniformGridPanel::SlotPadding' has a wrong offset!");
static_assert(offsetof(UUniformGridPanel, MinDesiredSlotWidth) == 0x000128, "Member 'UUniformGridPanel::MinDesiredSlotWidth' has a wrong offset!");
static_assert(offsetof(UUniformGridPanel, MinDesiredSlotHeight) == 0x00012C, "Member 'UUniformGridPanel::MinDesiredSlotHeight' has a wrong offset!");
...
public:
	...
	struct FMargin                                Padding;                                           // 0x0160(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                         BitPad_1AC_5 : 2;                                  // 0x01AC(0x0001)(Fixing Bit-Field Size Between Bits [ Dumper-7 ])
	...
	uint8                                         Pad_1B8[0x50];                                     // 0x01B8(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UUserWidget) == 0x000208, "Wrong size on UUserWidget");
static_assert(offsetof(UUserWidget, ColorAndOpacity) == 0x000108, "Member 'UUserWidget::ColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UUserWidget, ColorAndOpacityDelegate) == 0x000118, "Member 'UUserWidget::ColorAndOpacityDelegate' has a wrong offset!");
static_assert(offsetof(UUserWidget, ForegroundColor) == 0x000128, "Member 'UUserWidget::ForegroundColor' has a wrong offset!");
...
static_assert(offsetof(UUserWidget, Padding) == 0x000160, "Member 'UUserWidget::Padding' has a wrong offset!");
static_assert(offsetof(UUserWidget, ActiveSequencePlayers) == 0x000170, "Member 'UUserWidget::ActiveSequencePlayers' has a wrong offset!");
static_assert(offsetof(UUserWidget, StoppedSequencePlayers) == 0x000180, "Member 'UUserWidget::StoppedSequencePlayers' has a wrong offset!");
static_assert(offsetof(UUserWidget, NamedSlotBindings) == 0x000190, "Member 'UUserWidget::NamedSlotBindings' has a wrong offset!");
static_assert(offsetof(UUserWidget, WidgetTree) == 0x0001A0, "Member 'UUserWidget::WidgetTree' has a wrong offset!");
static_assert(offsetof(UUserWidget, Priority) == 0x0001A8, "Member 'UUserWidget::Priority' has a wrong offset!");
static_assert(offsetof(UUserWidget, InputComponent) == 0x0001B0, "Member 'UUserWidget::InputComponent' has a wrong offset!");
...
static_assert(sizeof(UVerticalBox) == 0x000128, "Wrong size on UVerticalBox");
...
static_assert(sizeof(UViewport) == 0x000140, "Wrong size on UViewport");
static_assert(offsetof(UViewport, BackgroundColor) == 0x000118, "Member 'UViewport::BackgroundColor' has a wrong offset!");
...
static_assert(sizeof(UVisibilityBinding) == 0x000048, "Wrong size on UVisibilityBinding");
...
static_assert(sizeof(UWidgetAnimation) == 0x000370, "Wrong size on UWidgetAnimation");
static_assert(offsetof(UWidgetAnimation, OnAnimationStarted) == 0x000330, "Member 'UWidgetAnimation::OnAnimationStarted' has a wrong offset!");
static_assert(offsetof(UWidgetAnimation, OnAnimationFinished) == 0x000340, "Member 'UWidgetAnimation::OnAnimationFinished' has a wrong offset!");
static_assert(offsetof(UWidgetAnimation, MovieScene) == 0x000350, "Member 'UWidgetAnimation::MovieScene' has a wrong offset!");
static_assert(offsetof(UWidgetAnimation, AnimationBindings) == 0x000358, "Member 'UWidgetAnimation::AnimationBindings' has a wrong offset!");
...
static_assert(sizeof(UWidgetBinding) == 0x000048, "Wrong size on UWidgetBinding");
...
public:
	...
	uint8                                         bValidTemplate : 1;                                // 0x02E0(0x0001)(BitIndex: 0x01, PropSize: 0x0001 (NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bTemplateInitialized : 1;                          // 0x02E0(0x0001)(BitIndex: 0x02, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
	uint8                                         bCookedTemplate : 1;                               // 0x02E0(0x0001)(BitIndex: 0x03, PropSize: 0x0001 (Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate))
...
static_assert(sizeof(UWidgetBlueprintGeneratedClass) == 0x000348, "Wrong size on UWidgetBlueprintGeneratedClass");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, WidgetTree) == 0x0002D8, "Member 'UWidgetBlueprintGeneratedClass::WidgetTree' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, Bindings) == 0x0002E8, "Member 'UWidgetBlueprintGeneratedClass::Bindings' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, Animations) == 0x0002F8, "Member 'UWidgetBlueprintGeneratedClass::Animations' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, NamedSlots) == 0x000308, "Member 'UWidgetBlueprintGeneratedClass::NamedSlots' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, TemplateAsset) == 0x000318, "Member 'UWidgetBlueprintGeneratedClass::TemplateAsset' has a wrong offset!");
static_assert(offsetof(UWidgetBlueprintGeneratedClass, Template) == 0x000340, "Member 'UWidgetBlueprintGeneratedClass::Template' has a wrong offset!");
...
{
public:
	EWidgetSpace                                  Space;                                             // 0x06A8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EWidgetTimingPolicy                           TimingPolicy;                                      // 0x06A9(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_6AA[0x6];                                      // 0x06AA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TSubclassOf<class UUserWidget>                WidgetClass;                                       // 0x06B0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FIntPoint                              DrawSize;                                          // 0x06B8(0x0008)(Edit, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bManuallyRedraw;                                   // 0x06C0(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bRedrawRequested;                                  // 0x06C1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_6C2[0x2];                                      // 0x06C2(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         RedrawTime;                                        // 0x06C4(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_6C8[0x8];                                      // 0x06C8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FIntPoint                              CurrentDrawSize;                                   // 0x06D0(0x0008)(IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bDrawAtDesiredSize;                                // 0x06D8(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_6D9[0x3];                                      // 0x06D9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              Pivot;                                             // 0x06DC(0x0008)(Edit, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bReceiveHardwareInput;                             // 0x06E4(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bWindowFocusable;                                  // 0x06E5(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_6E6[0x2];                                      // 0x06E6(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class ULocalPlayer*                           OwnerPlayer;                                       // 0x06E8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FLinearColor                           BackgroundColor;                                   // 0x06F0(0x0010)(Edit, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FLinearColor                           TintColorAndOpacity;                               // 0x0700(0x0010)(Edit, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	float                                         OpacityFromTexture;                                // 0x0710(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EWidgetBlendMode                              BlendMode;                                         // 0x0714(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bIsTwoSided;                                       // 0x0715(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          TickWhenOffscreen;                                 // 0x0716(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_717[0x1];                                      // 0x0717(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	class UUserWidget*                            Widget;                                            // 0x0718(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_720[0x20];                                     // 0x0720(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	class UBodySetup*                             BodySetup;                                         // 0x0740(0x0008)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     TranslucentMaterial;                               // 0x0748(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     TranslucentMaterial_OneSided;                      // 0x0750(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     OpaqueMaterial;                                    // 0x0758(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     OpaqueMaterial_OneSided;                           // 0x0760(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     MaskedMaterial;                                    // 0x0768(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInterface*                     MaskedMaterial_OneSided;                           // 0x0770(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UTextureRenderTarget2D*                 RenderTarget;                                      // 0x0778(0x0008)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UMaterialInstanceDynamic*               MaterialInstance;                                  // 0x0780(0x0008)(ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	...
	class FName                                   SharedLayerName;                                   // 0x0790(0x0008)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         LayerZOrder;                                       // 0x0798(0x0004)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	EWidgetGeometryMode                           GeometryMode;                                      // 0x079C(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_79D[0x3];                                      // 0x079D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CylinderArcAngle;                                  // 0x07A0(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UWidgetComponent) == 0x0007D0, "Wrong size on UWidgetComponent");
static_assert(offsetof(UWidgetComponent, Space) == 0x0006A8, "Member 'UWidgetComponent::Space' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TimingPolicy) == 0x0006A9, "Member 'UWidgetComponent::TimingPolicy' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, WidgetClass) == 0x0006B0, "Member 'UWidgetComponent::WidgetClass' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, DrawSize) == 0x0006B8, "Member 'UWidgetComponent::DrawSize' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bManuallyRedraw) == 0x0006C0, "Member 'UWidgetComponent::bManuallyRedraw' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bRedrawRequested) == 0x0006C1, "Member 'UWidgetComponent::bRedrawRequested' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, RedrawTime) == 0x0006C4, "Member 'UWidgetComponent::RedrawTime' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, CurrentDrawSize) == 0x0006D0, "Member 'UWidgetComponent::CurrentDrawSize' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bDrawAtDesiredSize) == 0x0006D8, "Member 'UWidgetComponent::bDrawAtDesiredSize' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, Pivot) == 0x0006DC, "Member 'UWidgetComponent::Pivot' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bReceiveHardwareInput) == 0x0006E4, "Member 'UWidgetComponent::bReceiveHardwareInput' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bWindowFocusable) == 0x0006E5, "Member 'UWidgetComponent::bWindowFocusable' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OwnerPlayer) == 0x0006E8, "Member 'UWidgetComponent::OwnerPlayer' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, BackgroundColor) == 0x0006F0, "Member 'UWidgetComponent::BackgroundColor' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TintColorAndOpacity) == 0x000700, "Member 'UWidgetComponent::TintColorAndOpacity' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OpacityFromTexture) == 0x000710, "Member 'UWidgetComponent::OpacityFromTexture' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, BlendMode) == 0x000714, "Member 'UWidgetComponent::BlendMode' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bIsTwoSided) == 0x000715, "Member 'UWidgetComponent::bIsTwoSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TickWhenOffscreen) == 0x000716, "Member 'UWidgetComponent::TickWhenOffscreen' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, Widget) == 0x000718, "Member 'UWidgetComponent::Widget' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, BodySetup) == 0x000740, "Member 'UWidgetComponent::BodySetup' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TranslucentMaterial) == 0x000748, "Member 'UWidgetComponent::TranslucentMaterial' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, TranslucentMaterial_OneSided) == 0x000750, "Member 'UWidgetComponent::TranslucentMaterial_OneSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OpaqueMaterial) == 0x000758, "Member 'UWidgetComponent::OpaqueMaterial' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, OpaqueMaterial_OneSided) == 0x000760, "Member 'UWidgetComponent::OpaqueMaterial_OneSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, MaskedMaterial) == 0x000768, "Member 'UWidgetComponent::MaskedMaterial' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, MaskedMaterial_OneSided) == 0x000770, "Member 'UWidgetComponent::MaskedMaterial_OneSided' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, RenderTarget) == 0x000778, "Member 'UWidgetComponent::RenderTarget' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, MaterialInstance) == 0x000780, "Member 'UWidgetComponent::MaterialInstance' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bAddedToScreen) == 0x000788, "Member 'UWidgetComponent::bAddedToScreen' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, bEditTimeUsable) == 0x000789, "Member 'UWidgetComponent::bEditTimeUsable' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, SharedLayerName) == 0x000790, "Member 'UWidgetComponent::SharedLayerName' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, LayerZOrder) == 0x000798, "Member 'UWidgetComponent::LayerZOrder' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, GeometryMode) == 0x00079C, "Member 'UWidgetComponent::GeometryMode' has a wrong offset!");
static_assert(offsetof(UWidgetComponent, CylinderArcAngle) == 0x0007A0, "Member 'UWidgetComponent::CylinderArcAngle' has a wrong offset!");
...
static_assert(sizeof(UWidgetNavigation) == 0x000118, "Wrong size on UWidgetNavigation");
static_assert(offsetof(UWidgetNavigation, Up) == 0x000028, "Member 'UWidgetNavigation::Up' has a wrong offset!");
static_assert(offsetof(UWidgetNavigation, Down) == 0x000050, "Member 'UWidgetNavigation::Down' has a wrong offset!");
static_assert(offsetof(UWidgetNavigation, Left) == 0x000078, "Member 'UWidgetNavigation::Left' has a wrong offset!");
static_assert(offsetof(UWidgetNavigation, Right) == 0x0000A0, "Member 'UWidgetNavigation::Right' has a wrong offset!");
static_assert(offsetof(UWidgetNavigation, Next) == 0x0000C8, "Member 'UWidgetNavigation::Next' has a wrong offset!");
static_assert(offsetof(UWidgetNavigation, Previous) == 0x0000F0, "Member 'UWidgetNavigation::Previous' has a wrong offset!");
...
static_assert(sizeof(UWidgetSwitcher) == 0x000130, "Wrong size on UWidgetSwitcher");
static_assert(offsetof(UWidgetSwitcher, ActiveWidgetIndex) == 0x000118, "Member 'UWidgetSwitcher::ActiveWidgetIndex' has a wrong offset!");
...
static_assert(sizeof(UWidgetTree) == 0x000040, "Wrong size on UWidgetTree");
static_assert(offsetof(UWidgetTree, RootWidget) == 0x000028, "Member 'UWidgetTree::RootWidget' has a wrong offset!");
static_assert(offsetof(UWidgetTree, AllWidgets) == 0x000030, "Member 'UWidgetTree::AllWidgets' has a wrong offset!");
...
{
public:
	bool                                          bDoubleClickTogglesFullscreen;                     // 0x0118(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UWindowTitleBarArea) == 0x000138, "Wrong size on UWindowTitleBarArea");
static_assert(offsetof(UWindowTitleBarArea, bDoubleClickTogglesFullscreen) == 0x000118, "Member 'UWindowTitleBarArea::bDoubleClickTogglesFullscreen' has a wrong offset!");
