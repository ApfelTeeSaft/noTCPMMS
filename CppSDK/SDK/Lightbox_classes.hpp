...
public:
	...
	UMulticastDelegateProperty_                   IntroEnded;                                        // 0x0238(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	UMulticastDelegateProperty_                   OutroEnded;                                        // 0x0248(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(sizeof(ULightbox_C) == 0x000258, "Wrong size on ULightbox_C");
...
static_assert(offsetof(ULightbox_C, IntroEnded) == 0x000238, "Member 'ULightbox_C::IntroEnded' has a wrong offset!");
static_assert(offsetof(ULightbox_C, OutroEnded) == 0x000248, "Member 'ULightbox_C::OutroEnded' has a wrong offset!");
