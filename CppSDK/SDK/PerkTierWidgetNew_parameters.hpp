...
public:
	...
	class UFortPerkWidget_NUI*                    PerkWidget_0;                                      // 0x0098(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
