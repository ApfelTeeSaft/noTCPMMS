...
public:
	...
	bool                                          bIsNetDirty;                                       // 0x00F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UGameplayTasksComponent) == 0x000170, "Wrong size on UGameplayTasksComponent");
static_assert(offsetof(UGameplayTasksComponent, bIsNetDirty) == 0x0000F8, "Member 'UGameplayTasksComponent::bIsNetDirty' has a wrong offset!");
...
static_assert(offsetof(UGameplayTasksComponent, TaskPriorityQueue) == 0x000110, "Member 'UGameplayTasksComponent::TaskPriorityQueue' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, TickingTasks) == 0x000130, "Member 'UGameplayTasksComponent::TickingTasks' has a wrong offset!");
static_assert(offsetof(UGameplayTasksComponent, KnownTasks) == 0x000140, "Member 'UGameplayTasksComponent::KnownTasks' has a wrong offset!");
