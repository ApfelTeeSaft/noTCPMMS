...
public:
	...
	int32                                         CurrentTier_0;                                     // 0x0004(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(ItemTransformResultInfo_C_CalculateCurrentSacrificePoints, CallFunc_GetContext_ReturnValue) == 0x000010, "Member 'ItemTransformResultInfo_C_CalculateCurrentSacrificePoints::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformResultInfo_C_CalculateCurrentSacrificePoints, Temp_int_Loop_Counter_Variable) == 0x000018, "Member 'ItemTransformResultInfo_C_CalculateCurrentSacrificePoints::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(ItemTransformResultInfo_C_CalculateCurrentSacrificePoints, CallFunc_Add_IntInt_ReturnValue) == 0x00001C, "Member 'ItemTransformResultInfo_C_CalculateCurrentSacrificePoints::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformResultInfo_C_CalculateCurrentSacrificePoints, CallFunc_Array_Get_Item) == 0x000020, "Member 'ItemTransformResultInfo_C_CalculateCurrentSacrificePoints::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(ItemTransformResultInfo_C_CalculateCurrentSacrificePoints, CallFunc_Array_Length_ReturnValue) == 0x000028, "Member 'ItemTransformResultInfo_C_CalculateCurrentSacrificePoints::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformResultInfo_C_CalculateCurrentSacrificePoints, CallFunc_IsValid_ReturnValue) == 0x00002C, "Member 'ItemTransformResultInfo_C_CalculateCurrentSacrificePoints::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformResultInfo_C_CalculateCurrentSacrificePoints, CallFunc_Less_IntInt_ReturnValue) == 0x00002D, "Member 'ItemTransformResultInfo_C_CalculateCurrentSacrificePoints::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ItemTransformResultInfo_C_CalculateCurrentSacrificePoints, CallFunc_GetItemDefinitionBP_ReturnValue) == 0x000030, "Member 'ItemTransformResultInfo_C_CalculateCurrentSacrificePoints::CallFunc_GetItemDefinitionBP_ReturnValue' has a wrong offset!");
