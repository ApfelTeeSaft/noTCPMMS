...
public:
	...
	struct FFortTabButtonLabelInfo                K2Node_Event_TabLabelInfo;                         // 0x0008(0x0090)()
	bool                                          CallFunc_EqualEqual_ClassClass_ReturnValue3;       // 0x0098(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_EqualEqual_ClassClass_ReturnValue4;       // 0x0099(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_EqualEqual_ByteByte_ReturnValue;          // 0x009A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_EqualEqual_ClassClass_ReturnValue5;       // 0x009B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_EqualEqual_ClassClass_ReturnValue6;       // 0x009C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          K2Node_Event_IsDesignTime;                         // 0x009D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_9E[0x2];                                       // 0x009E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class UClass*                                 CallFunc_GetCurrentTextStyleClass_ReturnValue;     // 0x00A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_EqualEqual_ClassClass_ReturnValue7;       // 0x00A8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_A9[0x7];                                       // 0x00A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UClass*                                 CallFunc_GetCurrentTextStyleClass_ReturnValue2;    // 0x00B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UFortQuestManager*                      CallFunc_GetQuestManager_ReturnValue;              // 0x00D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton) == 0x0000E0, "Wrong size on QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton");
...
static_assert(offsetof(QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton, CallFunc_EqualEqual_ClassClass_ReturnValue3) == 0x000098, "Member 'QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton::CallFunc_EqualEqual_ClassClass_ReturnValue3' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton, CallFunc_EqualEqual_ClassClass_ReturnValue4) == 0x000099, "Member 'QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton::CallFunc_EqualEqual_ClassClass_ReturnValue4' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x00009A, "Member 'QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton, CallFunc_EqualEqual_ClassClass_ReturnValue5) == 0x00009B, "Member 'QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton::CallFunc_EqualEqual_ClassClass_ReturnValue5' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton, CallFunc_EqualEqual_ClassClass_ReturnValue6) == 0x00009C, "Member 'QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton::CallFunc_EqualEqual_ClassClass_ReturnValue6' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton, K2Node_Event_IsDesignTime) == 0x00009D, "Member 'QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton, CallFunc_GetCurrentTextStyleClass_ReturnValue) == 0x0000A0, "Member 'QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton::CallFunc_GetCurrentTextStyleClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton, CallFunc_EqualEqual_ClassClass_ReturnValue7) == 0x0000A8, "Member 'QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton::CallFunc_EqualEqual_ClassClass_ReturnValue7' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton, CallFunc_GetCurrentTextStyleClass_ReturnValue2) == 0x0000B0, "Member 'QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton::CallFunc_GetCurrentTextStyleClass_ReturnValue2' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton, CallFunc_GetContext_ReturnValue) == 0x0000B8, "Member 'QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton, K2Node_CreateDelegate_OutputDelegate) == 0x0000C0, "Member 'QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton, CallFunc_GetQuestManager_ReturnValue) == 0x0000D0, "Member 'QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton::CallFunc_GetQuestManager_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton, CallFunc_IsValid_ReturnValue) == 0x0000D8, "Member 'QuestsCountIconTabButton_C_ExecuteUbergraph_QuestsCountIconTabButton::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(QuestsCountIconTabButton_C_SetTabLabelInfo) == 0x000090, "Wrong size on QuestsCountIconTabButton_C_SetTabLabelInfo");
...
static_assert(sizeof(QuestsCountIconTabButton_C_Set_Icon) == 0x000078, "Wrong size on QuestsCountIconTabButton_C_Set_Icon");
...
public:
	...
	class UFortQuestItem*                         CallFunc_Array_Get_Item2;                          // 0x0058(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EFortQuestState                               CallFunc_GetQuestState_ReturnValue;                // 0x0060(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_Less_IntInt_ReturnValue2;                 // 0x0069(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(QuestsCountIconTabButton_C_Update_Text) == 0x000070, "Wrong size on QuestsCountIconTabButton_C_Update_Text");
...
static_assert(offsetof(QuestsCountIconTabButton_C_Update_Text, Temp_int_Array_Index_Variable) == 0x000004, "Member 'QuestsCountIconTabButton_C_Update_Text::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_Update_Text, Temp_int_Loop_Counter_Variable) == 0x000008, "Member 'QuestsCountIconTabButton_C_Update_Text::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_Update_Text, CallFunc_Add_IntInt_ReturnValue) == 0x00000C, "Member 'QuestsCountIconTabButton_C_Update_Text::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_Update_Text, Temp_int_Array_Index_Variable2) == 0x000010, "Member 'QuestsCountIconTabButton_C_Update_Text::Temp_int_Array_Index_Variable2' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_Update_Text, Temp_int_Loop_Counter_Variable2) == 0x000014, "Member 'QuestsCountIconTabButton_C_Update_Text::Temp_int_Loop_Counter_Variable2' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_Update_Text, CallFunc_Add_IntInt_ReturnValue2) == 0x000018, "Member 'QuestsCountIconTabButton_C_Update_Text::CallFunc_Add_IntInt_ReturnValue2' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_Update_Text, CallFunc_Add_IntInt_ReturnValue3) == 0x00001C, "Member 'QuestsCountIconTabButton_C_Update_Text::CallFunc_Add_IntInt_ReturnValue3' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_Update_Text, CallFunc_GetContext_ReturnValue) == 0x000020, "Member 'QuestsCountIconTabButton_C_Update_Text::CallFunc_GetContext_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(QuestsCountIconTabButton_C_Update_Text, CallFunc_IsValid_ReturnValue) == 0x000030, "Member 'QuestsCountIconTabButton_C_Update_Text::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_Update_Text, CallFunc_GetCurrentQuestsCategories_Categories) == 0x000038, "Member 'QuestsCountIconTabButton_C_Update_Text::CallFunc_GetCurrentQuestsCategories_Categories' has a wrong offset!");
...
static_assert(offsetof(QuestsCountIconTabButton_C_Update_Text, CallFunc_Less_IntInt_ReturnValue) == 0x000054, "Member 'QuestsCountIconTabButton_C_Update_Text::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_Update_Text, CallFunc_Array_Get_Item2) == 0x000058, "Member 'QuestsCountIconTabButton_C_Update_Text::CallFunc_Array_Get_Item2' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_Update_Text, CallFunc_GetQuestState_ReturnValue) == 0x000060, "Member 'QuestsCountIconTabButton_C_Update_Text::CallFunc_GetQuestState_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_Update_Text, CallFunc_Array_Length_ReturnValue2) == 0x000064, "Member 'QuestsCountIconTabButton_C_Update_Text::CallFunc_Array_Length_ReturnValue2' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_Update_Text, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000068, "Member 'QuestsCountIconTabButton_C_Update_Text::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(QuestsCountIconTabButton_C_Update_Text, CallFunc_Less_IntInt_ReturnValue2) == 0x000069, "Member 'QuestsCountIconTabButton_C_Update_Text::CallFunc_Less_IntInt_ReturnValue2' has a wrong offset!");
...
static_assert(alignof(QuestsCountIconTabButton_C_SetTutorialNameID) == 0x000008, "Wrong alignment on QuestsCountIconTabButton_C_SetTutorialNameID");
