...
// Parameters:
// struct FHeroCoreStat                    Data_0                                                 (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
// float                                   Value_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UTooltipMinusCoreStat_C::Update(const struct FHeroCoreStat& Data_0, float Value_0)
{
	static class UFunction* Func = nullptr;
