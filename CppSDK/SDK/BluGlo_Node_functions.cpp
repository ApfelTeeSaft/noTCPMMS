...
// Parameters:
// struct FVector                          StartLocation_0                                        (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// Parameters:
// struct FGuid                            MissionGuid                                            (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
bool ABluGlo_Node_C::BlueprintCanInteract(class AFortPawn* InteractingPawn) const
{
	static class UFunction* Func = nullptr;
...
class FText ABluGlo_Node_C::BlueprintGetInteractionString(class AFortPawn* InteractingPawn) const
{
	static class UFunction* Func = nullptr;
