...
static_assert(sizeof(UBP_ItemTransform_TabButton_C) == 0x000890, "Wrong size on UBP_ItemTransform_TabButton_C");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, UberGraphFrame) == 0x000780, "Member 'UBP_ItemTransform_TabButton_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, AvailableVehicles) == 0x000788, "Member 'UBP_ItemTransform_TabButton_C::AvailableVehicles' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, CenterButtonTextWidget) == 0x000790, "Member 'UBP_ItemTransform_TabButton_C::CenterButtonTextWidget' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, Heading) == 0x000798, "Member 'UBP_ItemTransform_TabButton_C::Heading' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, LeftSideImage) == 0x0007A0, "Member 'UBP_ItemTransform_TabButton_C::LeftSideImage' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, NormalBangWrapper_0) == 0x0007A8, "Member 'UBP_ItemTransform_TabButton_C::NormalBangWrapper_0' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, ButtonText) == 0x0007B0, "Member 'UBP_ItemTransform_TabButton_C::ButtonText' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, IconBrush) == 0x0007C8, "Member 'UBP_ItemTransform_TabButton_C::IconBrush' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, TabId) == 0x000840, "Member 'UBP_ItemTransform_TabButton_C::TabId' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, Hovered_Icon_Tint) == 0x000848, "Member 'UBP_ItemTransform_TabButton_C::Hovered_Icon_Tint' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, Selected_Icon_Tint) == 0x000858, "Member 'UBP_ItemTransform_TabButton_C::Selected_Icon_Tint' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, Deselected_Icon_Tint) == 0x000868, "Member 'UBP_ItemTransform_TabButton_C::Deselected_Icon_Tint' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, LandVehicles) == 0x000878, "Member 'UBP_ItemTransform_TabButton_C::LandVehicles' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, LandVehiclesAvailable) == 0x00087C, "Member 'UBP_ItemTransform_TabButton_C::LandVehiclesAvailable' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, SeaVehicles) == 0x000880, "Member 'UBP_ItemTransform_TabButton_C::SeaVehicles' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, SeaVehiclesAvailable) == 0x000884, "Member 'UBP_ItemTransform_TabButton_C::SeaVehiclesAvailable' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, AirVehicles) == 0x000888, "Member 'UBP_ItemTransform_TabButton_C::AirVehicles' has a wrong offset!");
static_assert(offsetof(UBP_ItemTransform_TabButton_C, AirVehiclesAvailable) == 0x00088C, "Member 'UBP_ItemTransform_TabButton_C::AirVehiclesAvailable' has a wrong offset!");
