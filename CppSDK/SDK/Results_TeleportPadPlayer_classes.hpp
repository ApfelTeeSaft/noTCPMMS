...
public:
	...
	class UOverlay*                               OverlayThumbs;                                     // 0x0258(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UResults_TeleportPadPlayerTop_C*        Top;                                               // 0x0260(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	bool                                          bIsValid;                                          // 0x0268(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          bIsLocalPlayer;                                    // 0x0269(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_26A[0x6];                                      // 0x026A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UTexture2D*                             ThumbsUp;                                          // 0x0270(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UTexture2D*                             ThumbsNeutral;                                     // 0x0278(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UResults_TeleportPadPlayer_C) == 0x000328, "Wrong size on UResults_TeleportPadPlayer_C");
static_assert(offsetof(UResults_TeleportPadPlayer_C, UberGraphFrame) == 0x000210, "Member 'UResults_TeleportPadPlayer_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, Anim_Outro) == 0x000218, "Member 'UResults_TeleportPadPlayer_C::Anim_Outro' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, Anim_InviteCheck) == 0x000220, "Member 'UResults_TeleportPadPlayer_C::Anim_InviteCheck' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, Anim_ThumbsPulse) == 0x000228, "Member 'UResults_TeleportPadPlayer_C::Anim_ThumbsPulse' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, Anim_ThumbsClick) == 0x000230, "Member 'UResults_TeleportPadPlayer_C::Anim_ThumbsClick' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, Anim_TeleportPadScreenIntro) == 0x000238, "Member 'UResults_TeleportPadPlayer_C::Anim_TeleportPadScreenIntro' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, ButtonInvite) == 0x000240, "Member 'UResults_TeleportPadPlayer_C::ButtonInvite' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, ButtonStats) == 0x000248, "Member 'UResults_TeleportPadPlayer_C::ButtonStats' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, ButtonThumbs) == 0x000250, "Member 'UResults_TeleportPadPlayer_C::ButtonThumbs' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, OverlayThumbs) == 0x000258, "Member 'UResults_TeleportPadPlayer_C::OverlayThumbs' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, Top) == 0x000260, "Member 'UResults_TeleportPadPlayer_C::Top' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, bIsValid) == 0x000268, "Member 'UResults_TeleportPadPlayer_C::bIsValid' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, bIsLocalPlayer) == 0x000269, "Member 'UResults_TeleportPadPlayer_C::bIsLocalPlayer' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, ThumbsUp) == 0x000270, "Member 'UResults_TeleportPadPlayer_C::ThumbsUp' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, ThumbsNeutral) == 0x000278, "Member 'UResults_TeleportPadPlayer_C::ThumbsNeutral' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, UniqueNetID) == 0x000280, "Member 'UResults_TeleportPadPlayer_C::UniqueNetID' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, OnMissionStatsClicked) == 0x0002A8, "Member 'UResults_TeleportPadPlayer_C::OnMissionStatsClicked' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, OnAddFriendClicked) == 0x0002B8, "Member 'UResults_TeleportPadPlayer_C::OnAddFriendClicked' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, OnUpVoteClicked) == 0x0002C8, "Member 'UResults_TeleportPadPlayer_C::OnUpVoteClicked' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, PlayerName) == 0x0002D8, "Member 'UResults_TeleportPadPlayer_C::PlayerName' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, OnTeleportPadIntroFinished) == 0x0002F0, "Member 'UResults_TeleportPadPlayer_C::OnTeleportPadIntroFinished' has a wrong offset!");
static_assert(offsetof(UResults_TeleportPadPlayer_C, ConsoleUniqueNetId) == 0x000300, "Member 'UResults_TeleportPadPlayer_C::ConsoleUniqueNetId' has a wrong offset!");
