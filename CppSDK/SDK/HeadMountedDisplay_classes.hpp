...
public:
	...
	uint8                                         Pad_68D[0x53];                                     // 0x068D(0x0053)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMotionControllerComponent) == 0x0006E0, "Wrong size on UMotionControllerComponent");
static_assert(offsetof(UMotionControllerComponent, PlayerIndex) == 0x000680, "Member 'UMotionControllerComponent::PlayerIndex' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, Hand) == 0x000684, "Member 'UMotionControllerComponent::Hand' has a wrong offset!");
static_assert(offsetof(UMotionControllerComponent, CurrentTrackingStatus) == 0x00068C, "Member 'UMotionControllerComponent::CurrentTrackingStatus' has a wrong offset!");
