...
public:
	...
	struct FUniqueNetIdRepl                       K2Node_CustomEvent_UniqueId;                       // 0x0020(0x0028)(ConstParm, HasGetValueTypeHash)
};
...
static_assert(sizeof(PowerRequirement_C_ExecuteUbergraph_PowerRequirement) == 0x000048, "Wrong size on PowerRequirement_C_ExecuteUbergraph_PowerRequirement");
...
static_assert(sizeof(PowerRequirement_C_PlayerInfoChanged) == 0x000028, "Wrong size on PowerRequirement_C_PlayerInfoChanged");
...
{
public:
	int32                                         RequiredPower_0;                                   // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         RecommendedPower_0;                                // 0x0004(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	struct FUniqueNetIdRepl                       CallFunc_GetUniqueID_ReturnValue;                  // 0x0020(0x0028)(HasGetValueTypeHash)
	bool                                          CallFunc_Greater_IntInt_ReturnValue2;              // 0x0048(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_49[0x7];                                       // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UHomeBaseContext*                       CallFunc_GetContext_ReturnValue;                   // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(PowerRequirement_C_Update) == 0x000068, "Wrong size on PowerRequirement_C_Update");
...
static_assert(offsetof(PowerRequirement_C_Update, CallFunc_Greater_IntInt_ReturnValue2) == 0x000048, "Member 'PowerRequirement_C_Update::CallFunc_Greater_IntInt_ReturnValue2' has a wrong offset!");
static_assert(offsetof(PowerRequirement_C_Update, CallFunc_GetContext_ReturnValue) == 0x000050, "Member 'PowerRequirement_C_Update::CallFunc_GetContext_ReturnValue' has a wrong offset!");
static_assert(offsetof(PowerRequirement_C_Update, CallFunc_GetTotalHomebaseRating_Rating) == 0x000058, "Member 'PowerRequirement_C_Update::CallFunc_GetTotalHomebaseRating_Rating' has a wrong offset!");
static_assert(offsetof(PowerRequirement_C_Update, CallFunc_GetTotalHomebaseRating_ProgressFraction) == 0x00005C, "Member 'PowerRequirement_C_Update::CallFunc_GetTotalHomebaseRating_ProgressFraction' has a wrong offset!");
static_assert(offsetof(PowerRequirement_C_Update, CallFunc_GetTotalHomebaseRating_ReturnValue) == 0x000060, "Member 'PowerRequirement_C_Update::CallFunc_GetTotalHomebaseRating_ReturnValue' has a wrong offset!");
static_assert(offsetof(PowerRequirement_C_Update, CallFunc_Greater_IntInt_ReturnValue3) == 0x000061, "Member 'PowerRequirement_C_Update::CallFunc_Greater_IntInt_ReturnValue3' has a wrong offset!");
static_assert(offsetof(PowerRequirement_C_Update, CallFunc_BooleanAND_ReturnValue) == 0x000062, "Member 'PowerRequirement_C_Update::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
...
{
public:
	int32                                         PartyPower;                                        // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
