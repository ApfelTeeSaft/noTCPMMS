...
static_assert(sizeof(UFrontEndRewards_ChoiceRewards_C) == 0x000310, "Wrong size on UFrontEndRewards_ChoiceRewards_C");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, UberGraphFrame) == 0x000238, "Member 'UFrontEndRewards_ChoiceRewards_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, AnimFadeOut) == 0x000240, "Member 'UFrontEndRewards_ChoiceRewards_C::AnimFadeOut' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, AnimFadeIn) == 0x000248, "Member 'UFrontEndRewards_ChoiceRewards_C::AnimFadeIn' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, BorderConfirmationDim) == 0x000250, "Member 'UFrontEndRewards_ChoiceRewards_C::BorderConfirmationDim' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, ButtonNo) == 0x000258, "Member 'UFrontEndRewards_ChoiceRewards_C::ButtonNo' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, ButtonYes) == 0x000260, "Member 'UFrontEndRewards_ChoiceRewards_C::ButtonYes' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, CanvasPanelCardList) == 0x000268, "Member 'UFrontEndRewards_ChoiceRewards_C::CanvasPanelCardList' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, CommonBorder_0) == 0x000270, "Member 'UFrontEndRewards_ChoiceRewards_C::CommonBorder_0' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, OverlayMain) == 0x000278, "Member 'UFrontEndRewards_ChoiceRewards_C::OverlayMain' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, SizeBoxCanvasSize) == 0x000280, "Member 'UFrontEndRewards_ChoiceRewards_C::SizeBoxCanvasSize' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, TextDescriptionHeader) == 0x000288, "Member 'UFrontEndRewards_ChoiceRewards_C::TextDescriptionHeader' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, TextDescriptionSummary) == 0x000290, "Member 'UFrontEndRewards_ChoiceRewards_C::TextDescriptionSummary' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, VerticalBoxConfirmation) == 0x000298, "Member 'UFrontEndRewards_ChoiceRewards_C::VerticalBoxConfirmation' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, VerticalBoxDescription) == 0x0002A0, "Member 'UFrontEndRewards_ChoiceRewards_C::VerticalBoxDescription' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, CardPadding) == 0x0002A8, "Member 'UFrontEndRewards_ChoiceRewards_C::CardPadding' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, CardList) == 0x0002B0, "Member 'UFrontEndRewards_ChoiceRewards_C::CardList' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, CardSelectionIndex) == 0x0002C0, "Member 'UFrontEndRewards_ChoiceRewards_C::CardSelectionIndex' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, ScaleDuration) == 0x0002C4, "Member 'UFrontEndRewards_ChoiceRewards_C::ScaleDuration' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, OnRewardSelected) == 0x0002C8, "Member 'UFrontEndRewards_ChoiceRewards_C::OnRewardSelected' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, CardSidePadding) == 0x0002D8, "Member 'UFrontEndRewards_ChoiceRewards_C::CardSidePadding' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, HighlightedScale) == 0x0002DC, "Member 'UFrontEndRewards_ChoiceRewards_C::HighlightedScale' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, NormalScale) == 0x0002E0, "Member 'UFrontEndRewards_ChoiceRewards_C::NormalScale' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, BackgroundScale) == 0x0002E4, "Member 'UFrontEndRewards_ChoiceRewards_C::BackgroundScale' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, NormalShadowDepth) == 0x0002E8, "Member 'UFrontEndRewards_ChoiceRewards_C::NormalShadowDepth' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, BackgroundShadowDepth) == 0x0002EC, "Member 'UFrontEndRewards_ChoiceRewards_C::BackgroundShadowDepth' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, HighlightedShadowDepth) == 0x0002F0, "Member 'UFrontEndRewards_ChoiceRewards_C::HighlightedShadowDepth' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, InspectAction) == 0x0002F8, "Member 'UFrontEndRewards_ChoiceRewards_C::InspectAction' has a wrong offset!");
static_assert(offsetof(UFrontEndRewards_ChoiceRewards_C, bCardSelectionDisabled) == 0x000308, "Member 'UFrontEndRewards_ChoiceRewards_C::bCardSelectionDisabled' has a wrong offset!");
