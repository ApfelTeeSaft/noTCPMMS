...
public:
	...
	struct FSlateBrush                            CallFunc_GetBrushBySizeFromMultiSizeBrush_ReturnValue; // 0x0108(0x0078)()
	struct FSlateBrush                            CallFunc_GetBrushForKey_Brush;                     // 0x0180(0x0078)()
	bool                                          CallFunc_GetBrushForKey_ReturnValue;               // 0x01F8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          Temp_bool_Variable2;                               // 0x01F9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1FA[0x6];                                      // 0x01FA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_GetText_ReturnValue;                      // 0x0200(0x0018)()
	int32                                         K2Node_Select2_Default;                            // 0x0218(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_TextIsEmpty_ReturnValue;                  // 0x021C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(KeybindWidget_C_ExecuteUbergraph_KeybindWidget) == 0x000220, "Wrong size on KeybindWidget_C_ExecuteUbergraph_KeybindWidget");
...
static_assert(offsetof(KeybindWidget_C_ExecuteUbergraph_KeybindWidget, CallFunc_GetBrushForKey_Brush) == 0x000180, "Member 'KeybindWidget_C_ExecuteUbergraph_KeybindWidget::CallFunc_GetBrushForKey_Brush' has a wrong offset!");
static_assert(offsetof(KeybindWidget_C_ExecuteUbergraph_KeybindWidget, CallFunc_GetBrushForKey_ReturnValue) == 0x0001F8, "Member 'KeybindWidget_C_ExecuteUbergraph_KeybindWidget::CallFunc_GetBrushForKey_ReturnValue' has a wrong offset!");
static_assert(offsetof(KeybindWidget_C_ExecuteUbergraph_KeybindWidget, Temp_bool_Variable2) == 0x0001F9, "Member 'KeybindWidget_C_ExecuteUbergraph_KeybindWidget::Temp_bool_Variable2' has a wrong offset!");
static_assert(offsetof(KeybindWidget_C_ExecuteUbergraph_KeybindWidget, CallFunc_GetText_ReturnValue) == 0x000200, "Member 'KeybindWidget_C_ExecuteUbergraph_KeybindWidget::CallFunc_GetText_ReturnValue' has a wrong offset!");
static_assert(offsetof(KeybindWidget_C_ExecuteUbergraph_KeybindWidget, K2Node_Select2_Default) == 0x000218, "Member 'KeybindWidget_C_ExecuteUbergraph_KeybindWidget::K2Node_Select2_Default' has a wrong offset!");
static_assert(offsetof(KeybindWidget_C_ExecuteUbergraph_KeybindWidget, CallFunc_TextIsEmpty_ReturnValue) == 0x00021C, "Member 'KeybindWidget_C_ExecuteUbergraph_KeybindWidget::CallFunc_TextIsEmpty_ReturnValue' has a wrong offset!");
static_assert(offsetof(KeybindWidget_C_ExecuteUbergraph_KeybindWidget, K2Node_Select3_Default) == 0x00021D, "Member 'KeybindWidget_C_ExecuteUbergraph_KeybindWidget::K2Node_Select3_Default' has a wrong offset!");
