...
static_assert(sizeof(UPickupMessageItem_C) == 0x0002B0, "Wrong size on UPickupMessageItem_C");
static_assert(offsetof(UPickupMessageItem_C, UberGraphFrame) == 0x000258, "Member 'UPickupMessageItem_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UPickupMessageItem_C, Disappear) == 0x000260, "Member 'UPickupMessageItem_C::Disappear' has a wrong offset!");
static_assert(offsetof(UPickupMessageItem_C, Appear) == 0x000268, "Member 'UPickupMessageItem_C::Appear' has a wrong offset!");
static_assert(offsetof(UPickupMessageItem_C, _Size_Box__Message_Size) == 0x000270, "Member 'UPickupMessageItem_C::_Size_Box__Message_Size' has a wrong offset!");
static_assert(offsetof(UPickupMessageItem_C, _Stack_Counter__Count) == 0x000278, "Member 'UPickupMessageItem_C::_Stack_Counter__Count' has a wrong offset!");
static_assert(offsetof(UPickupMessageItem_C, BorderBackground) == 0x000280, "Member 'UPickupMessageItem_C::BorderBackground' has a wrong offset!");
static_assert(offsetof(UPickupMessageItem_C, Image_0) == 0x000288, "Member 'UPickupMessageItem_C::Image_0' has a wrong offset!");
static_assert(offsetof(UPickupMessageItem_C, ItemIcon) == 0x000290, "Member 'UPickupMessageItem_C::ItemIcon' has a wrong offset!");
static_assert(offsetof(UPickupMessageItem_C, SizeBoxItemImage) == 0x000298, "Member 'UPickupMessageItem_C::SizeBoxItemImage' has a wrong offset!");
static_assert(offsetof(UPickupMessageItem_C, TextItemName) == 0x0002A0, "Member 'UPickupMessageItem_C::TextItemName' has a wrong offset!");
static_assert(offsetof(UPickupMessageItem_C, Picked_Up_Item) == 0x0002A8, "Member 'UPickupMessageItem_C::Picked_Up_Item' has a wrong offset!");
