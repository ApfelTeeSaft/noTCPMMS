...
// Parameters:
// class FName                             SquadId_0                                              (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_FortExpeditionVehicleTileItemWidget_C::Set_Icon(class FName& SquadId_0)
{
	static class UFunction* Func = nullptr;
...
void UBP_FortExpeditionVehicleTileItemWidget_C::Set_Rating(class FName& SquadId_0)
{
	static class UFunction* Func = nullptr;
...
void UBP_FortExpeditionVehicleTileItemWidget_C::Set_Name(class FName SquadId_0)
{
	static class UFunction* Func = nullptr;
