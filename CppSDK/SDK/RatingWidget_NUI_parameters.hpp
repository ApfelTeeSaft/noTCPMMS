...
public:
	...
	TDelegate<void(struct FUniqueNetIdRepl& UniqueId)> K2Node_CreateDelegate_OutputDelegate2;             // 0x0058(0x0010)(ZeroConstructor, NoDestructor)
...
static_assert(sizeof(RatingWidget_NUI_C_ExecuteUbergraph_RatingWidget_NUI) == 0x000210, "Wrong size on RatingWidget_NUI_C_ExecuteUbergraph_RatingWidget_NUI");
...
static_assert(offsetof(RatingWidget_NUI_C_ExecuteUbergraph_RatingWidget_NUI, K2Node_CreateDelegate_OutputDelegate2) == 0x000058, "Member 'RatingWidget_NUI_C_ExecuteUbergraph_RatingWidget_NUI::K2Node_CreateDelegate_OutputDelegate2' has a wrong offset!");
static_assert(offsetof(RatingWidget_NUI_C_ExecuteUbergraph_RatingWidget_NUI, K2Node_CustomEvent_PlayerInfo) == 0x000068, "Member 'RatingWidget_NUI_C_ExecuteUbergraph_RatingWidget_NUI::K2Node_CustomEvent_PlayerInfo' has a wrong offset!");
...
static_assert(sizeof(RatingWidget_NUI_C_PlayerStateChanged) == 0x0001A8, "Wrong size on RatingWidget_NUI_C_PlayerStateChanged");
...
static_assert(sizeof(RatingWidget_NUI_C_PlayerInfoChanged) == 0x000028, "Wrong size on RatingWidget_NUI_C_PlayerInfoChanged");
...
static_assert(sizeof(RatingWidget_NUI_C_Set_Unique_ID) == 0x000028, "Wrong size on RatingWidget_NUI_C_Set_Unique_ID");
...
static_assert(sizeof(RatingWidget_NUI_C_Set_Texture2D_Parameter_From_Multi_Size_Brush) == 0x000368, "Wrong size on RatingWidget_NUI_C_Set_Texture2D_Parameter_From_Multi_Size_Brush");
...
static_assert(offsetof(RatingWidget_NUI_C_Set_Texture2D_Parameter_From_Multi_Size_Brush, CallFunc_GetBrushBySizeFromMultiSizeBrush_ReturnValue) == 0x0002E0, "Member 'RatingWidget_NUI_C_Set_Texture2D_Parameter_From_Multi_Size_Brush::CallFunc_GetBrushBySizeFromMultiSizeBrush_ReturnValue' has a wrong offset!");
static_assert(offsetof(RatingWidget_NUI_C_Set_Texture2D_Parameter_From_Multi_Size_Brush, K2Node_DynamicCast_AsTexture_2D) == 0x000358, "Member 'RatingWidget_NUI_C_Set_Texture2D_Parameter_From_Multi_Size_Brush::K2Node_DynamicCast_AsTexture_2D' has a wrong offset!");
static_assert(offsetof(RatingWidget_NUI_C_Set_Texture2D_Parameter_From_Multi_Size_Brush, K2Node_DynamicCast_bSuccess) == 0x000360, "Member 'RatingWidget_NUI_C_Set_Texture2D_Parameter_From_Multi_Size_Brush::K2Node_DynamicCast_bSuccess' has a wrong offset!");
