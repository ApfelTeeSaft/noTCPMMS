...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// EFortAthenaPlaylist                     LTMPlaylist_0                                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    AddSpecialStyle                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UAthenaMatchmakingOptionsDisplay_v2_C::AddLTM(EFortAthenaPlaylist LTMPlaylist_0, bool AddSpecialStyle)
{
	static class UFunction* Func = nullptr;
	...
	Parms.LTMPlaylist_0 = LTMPlaylist_0;
...
class UWidget* UAthenaMatchmakingOptionsDisplay_v2_C::Handle_Navigate_Right(EUINavigation Navigation_0)
{
	static class UFunction* Func = nullptr;
...
class UWidget* UAthenaMatchmakingOptionsDisplay_v2_C::Handle_Navigate_Left(EUINavigation Navigation_0)
{
	static class UFunction* Func = nullptr;
...
class UWidget* UAthenaMatchmakingOptionsDisplay_v2_C::Handle_Navigate_StandardModes_Up(EUINavigation Navigation_0)
{
	static class UFunction* Func = nullptr;
...
class UWidget* UAthenaMatchmakingOptionsDisplay_v2_C::Handle_Navigate_StandardModes_Down(EUINavigation Navigation_0)
{
	static class UFunction* Func = nullptr;
