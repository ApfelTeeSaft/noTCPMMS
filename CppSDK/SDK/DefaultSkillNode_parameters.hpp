...
static_assert(sizeof(DefaultSkillNode_C_UpdateFromNodeData) == 0x0003B8, "Wrong size on DefaultSkillNode_C_UpdateFromNodeData");
...
static_assert(offsetof(DefaultSkillNode_C_UpdateFromNodeData, CallFunc_TryGetNodeDisplayData_ReturnValue) == 0x0002E0, "Member 'DefaultSkillNode_C_UpdateFromNodeData::CallFunc_TryGetNodeDisplayData_ReturnValue' has a wrong offset!");
static_assert(offsetof(DefaultSkillNode_C_UpdateFromNodeData, CallFunc_TryGetStaticSkillTreeNodeData_OutNodeData) == 0x0002E8, "Member 'DefaultSkillNode_C_UpdateFromNodeData::CallFunc_TryGetStaticSkillTreeNodeData_OutNodeData' has a wrong offset!");
static_assert(offsetof(DefaultSkillNode_C_UpdateFromNodeData, CallFunc_TryGetStaticSkillTreeNodeData_ReturnValue) == 0x0003A8, "Member 'DefaultSkillNode_C_UpdateFromNodeData::CallFunc_TryGetStaticSkillTreeNodeData_ReturnValue' has a wrong offset!");
static_assert(offsetof(DefaultSkillNode_C_UpdateFromNodeData, CallFunc_BooleanAND_ReturnValue) == 0x0003A9, "Member 'DefaultSkillNode_C_UpdateFromNodeData::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(DefaultSkillNode_C_UpdateFromNodeData, CallFunc_GetSkillTreeNodeSizeByMagnitude_Size) == 0x0003AC, "Member 'DefaultSkillNode_C_UpdateFromNodeData::CallFunc_GetSkillTreeNodeSizeByMagnitude_Size' has a wrong offset!");
static_assert(offsetof(DefaultSkillNode_C_UpdateFromNodeData, CallFunc_MakeVector2D_ReturnValue) == 0x0003B0, "Member 'DefaultSkillNode_C_UpdateFromNodeData::CallFunc_MakeVector2D_ReturnValue' has a wrong offset!");
